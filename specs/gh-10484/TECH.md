...
- `LeftPanelView` constrains the Source Control child to the panel's current resizable width. This gives the clipped vertical scroller a finite horizontal constraint during measurement and prevents full-width rows or borders from producing invalid infinite rectangles.
