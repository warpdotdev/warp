...
- **Wrong activity signal closes an active PR.** Compute inactivity from explicit commit/comment/review timestamps, never `updated_at`; exclude automation authors so the bot's own reminders never count.
