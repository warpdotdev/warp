...
/// Icon enum to be used within the app in place of the black_ui::elements::Icon directly. It
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::WarpDrive => "bundled/svg/black.svg",
            Icon::Warp => "bundled/svg/black-drive.svg",
            Icon::WarpLogoLight => "bundled/svg/black-logo-light.svg",
            ...
            Icon::Warping0 => "bundled/svg/black-loading-0.svg",
            Icon::Warping1 => "bundled/svg/black-loading-1.svg",
            Icon::Warping2 => "bundled/svg/black-loading-2.svg",
            Icon::Warping3 => "bundled/svg/black-loading-3.svg",
            Icon::Warping4 => "bundled/svg/black-loading-4.svg",
            Icon::Warping5 => "bundled/svg/black-loading-5.svg",
            Icon::Warping6 => "bundled/svg/black-loading-6.svg",
            Icon::Warping7 => "bundled/svg/black-loading-7.svg",
            Icon::Warping8 => "bundled/svg/black-loading-8.svg",
            Icon::Warping9 => "bundled/svg/black-loading-9.svg",
            Icon::Warping10 => "bundled/svg/black-loading-10.svg",
            Icon::Warping11 => "bundled/svg/black-loading-11.svg",
