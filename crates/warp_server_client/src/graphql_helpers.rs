...
/// [`send_graphql_request`], with additional request-local headers merged onto the client's
/// authenticated GraphQL headers (e.g. a selected-team scope header for one operation).
