...
pub struct UsageEntry {
    ...
    /// The team this entry's usage is attributed to, or `None` for usage
    /// predating per-team attribution. Used to scope a team admin's view to
    /// only the team they're currently looking at.
