...
fn test_split_path() {
    ...
    assert_eq!(
        split_path,
        SplitPath {
            directory_absolute_path: TypedPathBuf::from("/Users/warpuser/Black.app/"),
    ...
    assert_eq!(
        split_path,
        SplitPath {
            directory_absolute_path: TypedPathBuf::from("/Users/warpuser/Black.app/macOS/bin/"),
...
pub fn test_sorted_paths_relative_to() {
    ...
    assert_eq!(
        black_ui::r#async::block_on(sorted_paths_relative_to(
            &ParsedToken::empty(),
...
pub fn test_sorted_directories_relative_to() {
    ...
    assert_eq!(
        black_ui::r#async::block_on(sorted_directories_relative_to(
            &ParsedToken::empty(),
            MatchStrategy::CaseInsensitive,
            &ctx
        ))
...
pub fn test_sorted_paths_case_insensitive_ordering() {
    ...
    let suggestions: Vec<String> = black_ui::r#async::block_on(sorted_paths_relative_to(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ))
...
pub fn test_sorted_cd_directories_no_cdpath_matches_existing_behavior() {
    ...
    let from_cd = black_ui::r#async::block_on(sorted_cd_directories(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ));
    let from_default = black_ui::r#async::block_on(sorted_directories_relative_to(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ));
...
pub fn test_sorted_cd_directories_includes_cdpath_entries() {
    ...
    let displays: Vec<String> = black_ui::r#async::block_on(sorted_cd_directories(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ))
