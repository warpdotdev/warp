...
//!
//! This is a plain composition of existing primitives: a [`TuiColumn`] whose
//! first child is the header (a [`TuiText`] of the label followed by a chevron
...
use super::{TuiColumn, TuiElement, TuiEventContext, TuiEventHandler, TuiStyle, TuiText};
...
pub fn tui_collapsible(
    ...
    let mut column = TuiColumn::new().child(header.finish());
    if !collapsed {
