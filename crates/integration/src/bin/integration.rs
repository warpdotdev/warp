...
fn register_tests() -> HashMap<&'static str, BoxedBuilderFn> {
    ...
    register_test!(test_detach_tab_group_to_new_window_with_drag);
    register_test!(test_attach_tab_group_to_other_window);
    register_test!(test_attach_tab_group_does_not_split_target_group);
    register_test!(test_whole_window_tab_group_attaches_to_other_window);
    register_test!(test_tab_group_drag_back_to_source_cancels);
    register_test!(test_detach_tab_group_to_new_window_in_vertical_tabs);
