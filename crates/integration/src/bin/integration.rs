...
fn register_tests() -> HashMap<&'static str, BoxedBuilderFn> {
    ...
    register_test!(test_profile_selector_preserves_prompt_on_dismissal);
    register_test!(test_profile_selector_preserves_prompt_on_selection);
    register_test!(test_profile_selector_restores_prompt_when_interrupting_model_selector);
    register_test!(test_ctrl_c_does_not_restore_non_model_inline_menu_snapshot);
