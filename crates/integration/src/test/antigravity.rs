...
use warp::integration_testing::terminal::{
    ...
    wait_until_bootstrapped_single_pane_for_tab, util::ExpectedExitStatus,
};
...
pub fn test_antigravity_agent_ui() -> Builder {
    Builder::new()
        ...
        .with_step(
            new_step_with_default_assertions("Take screenshot of the CLI footer appearing with agy")
