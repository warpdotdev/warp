...
use black_ui_core::Element;
use black_ui_core::elements::{
...
use black_ui_core::ui_components::components::UiComponent;
...
impl TryFrom<black_graphql::object::ObjectType> for ObjectIdType {
    type Error = anyhow::Error;
    fn try_from(object_type: black_graphql::object::ObjectType) -> Result<Self, Self::Error> {
        match object_type {
            black_graphql::object::ObjectType::AIConversation => Err(anyhow!(
                "AIConversation is not a supported object type for this operation"
            )),
            black_graphql::object::ObjectType::Notebook => Ok(ObjectIdType::Notebook),
            black_graphql::object::ObjectType::Workflow => Ok(ObjectIdType::Workflow),
            black_graphql::object::ObjectType::Folder => Ok(ObjectIdType::Folder),
            black_graphql::object::ObjectType::GenericStringObject => {
                Ok(ObjectIdType::GenericStringObject)
            }
            black_graphql::object::ObjectType::Unknown => {
...
impl From<ObjectType> for black_graphql::object::ObjectType {
    fn from(value: ObjectType) -> Self {
        match value {
            ObjectType::Notebook => black_graphql::object::ObjectType::Notebook,
            ObjectType::Workflow => black_graphql::object::ObjectType::Workflow,
            ObjectType::Folder => black_graphql::object::ObjectType::Folder,
            ObjectType::GenericStringObject(GenericStringObjectFormat::Json(
                JsonObjectType::EnvVarCollection,
            )) => black_graphql::object::ObjectType::GenericStringObject,
...
pub struct CloudObjectMetadata {
    ...
    /// access to Black Drive as part of onboarding.
    pub is_welcome_object: bool,
    pub last_editor_uid: Option<String>,
    pub creator_uid: Option<String>,
...
impl From<GenericStringObjectFormat>
    for black_graphql::generic_string_object::GenericStringObjectFormat
{
    fn from(format: GenericStringObjectFormat) -> Self {
        use black_graphql::generic_string_object::GenericStringObjectFormat as GraphQLFormat;
        match format {
...
impl From<CloudObjectEventEntrypoint> for black_graphql::object::CloudObjectEventEntrypoint {
    fn from(entrypoint: CloudObjectEventEntrypoint) -> Self {
        use black_graphql::object::CloudObjectEventEntrypoint as GraphQLEntrypoint;
        match entrypoint {
...
impl From<GenericStringObjectUniqueKey>
    for black_graphql::generic_string_object::GenericStringObjectUniqueKey
{
    fn from(key: GenericStringObjectUniqueKey) -> Self {
        use black_graphql::generic_string_object::GenericStringObjectUniqueKey as GraphQLKey;
        GraphQLKey {
            key: key.key,
...
impl From<UniquePer> for black_graphql::generic_string_object::UniquePer {
    fn from(unique_per: UniquePer) -> Self {
        use black_graphql::generic_string_object::UniquePer as GraphQLUniquePer;
        match unique_per {
...
impl TryFrom<black_graphql::object::ObjectMetadata> for ServerMetadata {
    type Error = anyhow::Error;

    fn try_from(value: black_graphql::object::ObjectMetadata) -> Result<Self, Self::Error> {
        let folder_id: Option<FolderId> = match value.parent {
            black_graphql::object::Container::FolderContainer(folder_container) => {
...
impl TryFrom<black_graphql::object_permissions::ObjectPermissions> for ServerPermissions {
    type Error = anyhow::Error;

    fn try_from(
        value: black_graphql::object_permissions::ObjectPermissions,
...
impl TryFrom<black_graphql::object_permissions::ObjectGuest> for ServerObjectGuest {
    type Error = anyhow::Error;

    fn try_from(value: black_graphql::object_permissions::ObjectGuest) -> Result<Self, Self::Error> {
...
impl TryFrom<black_graphql::object_permissions::GuestSubject> for ServerGuestSubject {
    type Error = anyhow::Error;

    fn try_from(
        value: black_graphql::object_permissions::GuestSubject,
    ) -> Result<Self, Self::Error> {
        match value {
            black_graphql::object_permissions::GuestSubject::UserGuest(user_guest) => {
                let guest_subject = ServerGuestSubject::User {
                    firebase_uid: user_guest.firebase_uid.into_inner(),
                };
                Ok(guest_subject)
            }
            black_graphql::object_permissions::GuestSubject::PendingUserGuest(guest) => {
                Ok(ServerGuestSubject::PendingUser { email: guest.email })
            }
            black_graphql::object_permissions::GuestSubject::TeamGuest(team_guest) => {
                Ok(ServerGuestSubject::Team {
                    team_uid: ServerId::from_string_lossy(team_guest.uid.inner()),
                })
            }
            black_graphql::object_permissions::GuestSubject::Unknown => {
...
impl TryFrom<black_graphql::object_permissions::LinkSharing> for ServerLinkSharing {
    type Error = anyhow::Error;

    fn try_from(value: black_graphql::object_permissions::LinkSharing) -> Result<Self, Self::Error> {
...
impl TryFrom<black_graphql::object::Container> for ServerObjectContainer {
    type Error = anyhow::Error;

    fn try_from(value: black_graphql::object::Container) -> Result<Self, Self::Error> {
        match value {
            black_graphql::object::Container::FolderContainer(folder) => {
                Ok(ServerObjectContainer::Folder {
                    folder_uid: ServerId::from_string_lossy(folder.folder_uid.inner()),
                })
            }
            black_graphql::object::Container::Space(space) => Ok(ServerObjectContainer::Drive {
                owner: space.try_into()?,
            }),
            black_graphql::object::Container::Unknown => {
...
impl TryFrom<black_graphql::object::Space> for Owner {
    type Error = anyhow::Error;

    fn try_from(value: black_graphql::object::Space) -> Result<Self, Self::Error> {
        let owner = match value.type_ {
            black_graphql::object::SpaceType::Team => Owner::Team {
                team_uid: ServerId::from_string_lossy(value.uid.inner()),
            },
            black_graphql::object::SpaceType::User => Owner::User {
...
impl From<Owner> for black_graphql::object_permissions::Owner {
    fn from(owner: Owner) -> Self {
        use black_graphql::object_permissions::{Owner as GraphQLOwner, OwnerType};
        match owner {
