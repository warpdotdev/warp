...
impl Iterator for RowIterator<'_> {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        let mut underline_color_iter = self.storage.underline_color_map.iter_from(start_offset);
        ...
        for grapheme_info in self.storage.index.grapheme_infos_for_row(self.row_index)? {
            ...
            let underline_color = next_attribute(&mut underline_color_iter, &grapheme);
