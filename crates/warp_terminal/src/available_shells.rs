...
#[cfg(feature = "local_tty")]
use warp_util::path::file_exists_and_is_executable;
#[cfg(feature = "local_tty")]
use warpui_core::{AppContext, ModelContext};
use warpui_core::{Entity, SingletonEntity};

use crate::shell::{ShellLaunchData, ShellType};
use crate::shell_settings::{NewSessionShell, StartupShell};
...
#[cfg(feature = "local_tty")]
impl crate::local_tty::shell::AvailableShell for AvailableShell {
...
impl TryFrom<StartupShell> for LocalConfig {
    ...
    fn try_from(value: StartupShell) -> Result<Self, Self::Error> {
        use crate::local_tty::shell::supported_shell_path_and_type;
...
impl AvailableShell {
    ...
    pub fn new_docker_sandbox_shell(sbx_path: PathBuf, base_image: Option<String>) -> Self {
        Self {
            id: None,
...
impl AvailableShells {
    ...
    fn get_user_preferred_shell_setting(&self, ctx: &AppContext) -> NewSessionShell {
        ...
        let new_session_shell_override = ShellSettings::as_ref(ctx)
            .new_session_shell_override
            .to_owned();
    ...
    fn get_user_preferred_shell_setting_fallback(&self, ctx: &AppContext) -> NewSessionShell {
        ...
        let startup_shell = ShellSettings::as_ref(ctx).startup_shell_override.to_owned();
        match startup_shell {
