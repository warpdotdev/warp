...
impl IntentionSlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let title = appearance
            .ui_builder()
            .paragraph(i18n::t("onboarding.intention.title"))
        ...
        let subtitle = FormattedTextElement::from_str(
            i18n::t("onboarding.intention.subtitle"),
    ...
    fn render_agent_card(
        ...
        let header_row = {
            let label = appearance
                .ui_builder()
                .paragraph(i18n::t("onboarding.intention.agent.title"))
                .with_style(UiComponentStyles {
                    font_size: Some(16.),
        ...
        let description = FormattedTextElement::from_str(
            i18n::t("onboarding.intention.agent.description"),
            appearance.ui_font_family(),
            14.,
        )
    ...
    fn render_terminal_card(
        ...
        let label = appearance
            .ui_builder()
            .paragraph(i18n::t("onboarding.intention.terminal.title"))
            .with_style(UiComponentStyles {
                font_size: Some(16.),
                font_weight: Some(Weight::Semibold),
        ...
        let badge = {
            let badge_text = appearance
                .ui_builder()
                .paragraph(i18n::t("onboarding.intention.terminal.no_ai_features"))
                .with_style(UiComponentStyles {
                    font_size: Some(12.),
                    font_weight: Some(Weight::Semibold),
                    font_color: Some(text_color),
        ...
        let description = FormattedTextElement::from_str(
            i18n::t("onboarding.intention.terminal.description"),
            appearance.ui_font_family(),
            14.,
        )
