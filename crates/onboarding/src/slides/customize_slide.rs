...
impl CustomizeUISlide {
    ...
    fn render_tab_styling_card(
        ...
        render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: crate::menu_label("onboarding.customize.tab_styling_title", "Tab styling"),
    ...
    fn render_tools_panel_card(
        ...
        if ui.tools_panel_enabled(&intention) {
            chips.push(ChipSpec {
                label: crate::menu_label(
                    "onboarding.customize.tools_chip_file_explorer",
                    "File explorer",
                ),
            ...
            if is_agent {
                chips.push(ChipSpec {
                    label: crate::menu_label(
                        "onboarding.customize.tools_chip_conversation_history",
            ...
            chips.push(ChipSpec {
                label: crate::menu_label(
                    "onboarding.customize.tools_chip_global_search",
                    "Global file search",
                ),
            ...
            chips.push(ChipSpec {
                label: crate::menu_label(
                    "onboarding.customize.tools_chip_warp_drive",
                    "Warp Drive",
                ),
        ...
        render_toggle_card(
            ...
            ToggleCardSpec {
                ...
                right_label: crate::menu_label("common.disabled", "Disabled"),
