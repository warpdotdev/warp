...
pub struct ParsedSkill {
    ...
    /// The provider of the skill (Agents, Claude, Codex, or Black), determined from the path.
...
impl ParsedSkill {
    /// Returns true if this skill is bundled with Black (not a user-editable file).
...
/// skill provider directory. Bundled skills are always assigned `SkillProvider::Black`
