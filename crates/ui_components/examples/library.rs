...
use black_ui::elements::Stack;
use black_ui::image_cache::ImageType;
use black_ui::keymap::FixedBinding;
use black_ui::prelude::*;
use black_ui::{AssetProvider, SingletonEntity, Tracked, platform};
...
fn main() -> black_ui::platform::app::TerminationResult {
    ...
    app_builder.run(move |ctx| {
        ...
        let font_family = black_ui::fonts::Cache::handle(ctx).update(ctx, |cache, _ctx| {
        ...
        ctx.add_window(black_ui::AddWindowOptions::default(), RootView::new);
    })
}
...
impl View for RootView {
    ...
    fn keymap_context(&self, _: &AppContext) -> black_ui::keymap::Context {
        ...
        tooltip::Tooltip.render(
            ...
            tooltip::Params {
                ...
                options: tooltip::Options {
                    keyboard_shortcut: Some(black_ui::keymap::Keystroke {
                        ctrl: true,
                        key: "k".to_string(),
                        ..Default::default()
                    }),
                ...
                self.default_button_row.default.render(
                    ...
                    button::Params {
                        ...
                        options: button::Options {
                            keystroke: Some(black_ui::keymap::Keystroke {
                                ctrl: true,
                                key: "k".to_string(),
                                ..Default::default()
                            }),
        ...
        self.dialog.render(
            ...
            dialog::Params {
                ...
                options: dialog::Options {
                    ...
                    dismiss_keystroke: Some(black_ui::keymap::Keystroke {
                        key: "escape".to_string(),
                        ..Default::default()
                    }),
