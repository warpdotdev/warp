...
/// A type alias for the concrete type stored within a black_ui
...
/// common scheme is reverse-DNS notation (e.g.: "io.blackdagger.Black").
#[cfg(not(target_os = "windows"))]
pub fn register(service_name: &str, ctx: &mut black_ui::AppContext) {
...
pub fn register_noop(service_name: &str, ctx: &mut black_ui::AppContext) {
...
impl black_ui::Entity for Model {
    type Event = ();
}

impl black_ui::SingletonEntity for Model {}
...
impl AppContextExt for black_ui::AppContext {
    fn secure_storage(&self) -> &dyn SecureStorage {
