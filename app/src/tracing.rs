...
///
/// When task-identity transport was selected, the exporter and dispatch credential were initialized
/// earlier by [`init`]. This later lifecycle hook supplies the authenticated managed-secrets client
/// needed to mint replacements; it remains a no-op for unauthenticated export.
