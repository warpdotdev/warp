...
impl TabData {
    ...
    fn session_sharing_menu_items(
            ...
            && ContextFlag::CreateSharedSession.is_enabled()
        {
            ...
            if let Some(focused_session_view) = focused_session_view {
                ...
                {
                    menu_items.push(
                        MenuItemFields::new(i18n::t("terminal.shared_session.stop_sharing"))
            ...
            if !shared_session_view_ids.is_empty() {
                menu_items.push(
                    MenuItemFields::new(i18n::t("terminal.shared_session.stop_sharing_all"))
    ...
    fn copy_metadata_menu_items(
        ...
        if !uses_vertical_tabs(ctx) {
            Self::push_copy_metadata_menu_item(
                &mut menu_items,
                i18n::t("tab.menu.copy_tab_title"),
                tab_title,
            );
            return menu_items;
        }
        ...
        let (title_label, title, terminal_view) = if matches!(
            ...
            (
                i18n::t("tab.menu.copy_pane_title"),
            ...
            (i18n::t("tab.menu.copy_tab_title"), tab_title, terminal_view)
        };
        ...
        if let Some(terminal_view) = terminal_view {
            ...
            Self::push_copy_metadata_menu_item(
                &mut menu_items,
                i18n::t("tab.menu.copy_working_directory"),
            ...
            Self::push_copy_metadata_menu_item(
                &mut menu_items,
                i18n::t("tab.menu.copy_pull_request_link"),
    ...
    fn modify_tab_menu_items(
        ...
        menu_items.append(&mut vec![MenuItemFields::new(i18n::t("tab.rename_tab"))
        ...
        if title.is_some() {
            menu_items.push(
                MenuItemFields::new(i18n::t("tab.reset_tab_name"))
    ...
    fn close_tab_menu_items(
        ...
        if ContextFlag::CloseWindow.is_enabled() || tabs_len != 1 {
            menu_items.push(
                MenuItemFields::new(i18n::t("tab.close_tab"))
        ...
        if tabs_len > 1 {
            menu_items.push(
                MenuItemFields::new(i18n::t("tab.close_other_tabs"))
    ...
    fn save_config_menu_items(index: usize) -> Vec<MenuItem<WorkspaceAction>> {
        ...
        vec![MenuItemFields::new(i18n::t("tab.save_as_new_config"))
    ...
    fn tab_group_menu_items() -> Vec<MenuItem<WorkspaceAction>> {
        ...
        vec![
            MenuItemFields::new(i18n::t("tab.new_group_with_tab")).into_item(),
            MenuItemFields::new_submenu(i18n::t("tab.move_to_group")).into_item(),
        ]
    }
                    ...
                    Hoverable::new(mouse_state, move |state| {
                        ...
                        if state.is_hovered() {
                            let tooltip = ui_builder
                                .tool_tip(i18n::t("tab.cloud_agent_run"))
                                .build()
                                .finish();
