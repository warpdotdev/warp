...
impl View for CommandSearchZeroStateView {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn warpui::Element> {
        ...
        let command_search_text = Container::new(
            Text::new_inline(
                i18n::t("search.command_search.zero_state.title"),
        ...
        let column = Flex::column()
            ...
            .with_child(
                Container::new(
                    Text::new_inline(
                        i18n::t("search.command_search.zero_state.looking_for"),
                        appearance.ui_font_family(),
            ...
            .with_child(
                Container::new(
                    Text::new_inline(
                        i18n::t("search.command_search.zero_state.example_queries"),
                        appearance.ui_font_family(),
                        styles::subheader_text_font_size(appearance),
                    )
                    .with_color(
