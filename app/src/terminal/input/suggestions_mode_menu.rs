        ...
        let (content, resize_config) = match status {
            ...
            DynamicEnumSuggestionStatus::Pending => (
                self.render_dynamic_enum_status_message(
                    i18n::t("terminal.input.dynamic_enum.pending"),
                    appearance,
                ),
                SuggestionsResizeConfig::WidthAndHeight,
            ),
            DynamicEnumSuggestionStatus::Failure => (
                self.render_dynamic_enum_status_message(
                    i18n::t("terminal.input.dynamic_enum.failure"),
                    appearance,
                ),
                SuggestionsResizeConfig::WidthAndHeight,
            ),
            DynamicEnumSuggestionStatus::Success if suggestions.is_empty() => (
                self.render_dynamic_enum_status_message(
                    i18n::t("terminal.input.dynamic_enum.no_results"),
                    appearance,
                ),
                SuggestionsResizeConfig::WidthAndHeight,
            ),
        ...
        Flex::column()
            .with_child(
                ConstrainedBox::new(
                    Container::new(
                        Text::new_inline(
                            i18n::t("terminal.input.dynamic_enum.generate"),
                    ...
                    Flex::row()
                        ...
                        .with_child(
                            Shrinkable::new(
                                ...
                                Container::new(
                                    Text::new_inline(
                                        i18n::t("terminal.input.dynamic_enum.run"),
                                        appearance.ui_font_family(),
                                        appearance.ui_font_size(),
                                    )
