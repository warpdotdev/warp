...
pub fn render_aws_bedrock_login_banner(
    ...
    let buttons = vec![
        InlineBannerTextButton {
            text: i18n::t("common.do_not_show_again"),
        ...
        InlineBannerTextButton {
            text: i18n::t("terminal.inline_banner.aws_bedrock.log_in"),
            text_color: active_ui_text_color,
            button_state: InlineBannerButtonState {
                on_click_event: TerminalAction::AwsBedrockLoginBanner(
    ...
    let description_text = warpui::elements::Text::new(
        i18n::t("terminal.inline_banner.aws_bedrock_enabled"),
    ...
    render_inline_block_list_banner(
        ...
        appearance,
        InlineBannerContent {
            title: i18n::t("terminal.inline_banner.aws_bedrock.title"),
