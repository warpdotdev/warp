...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        EditableBinding::new(
            ...
            i18n::t("find.binding.find_next_occurrence"),
            FindAction::CmdG,
        )
        ...
        EditableBinding::new(
            ...
            i18n::t("find.binding.find_previous_occurrence"),
...
impl<T: FindModel + Entity<Event = FindEvent> + 'static> Find<T> {
    pub fn new(model: ModelHandle<T>, ctx: &mut ViewContext<Self>) -> Self {
        let editor = ctx.add_typed_action_view(|ctx| {
            ...
            editor.set_placeholder_text(&i18n::t("find.placeholder"), ctx);
            editor
        });
...
impl<T: FindModel + Entity<Event = FindEvent> + 'static> View for Find<T> {
    ...
    fn accessibility_contents(&self, _: &AppContext) -> Option<AccessibilityContent> {
        Some(AccessibilityContent::new(
            i18n::t("find.a11y.type_phrase"),
            i18n::t("find.a11y.input_help"),
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let regex_icon = self.render_hoverable_icon_in_editor(
            ...
            editor_height,
            Some(i18n::t("find.regex_toggle_tooltip")),
            ICON_PADDING,
        );
        let case_sensitive_icon = Container::new(
            SavePosition::new(
                self.render_hoverable_icon_in_editor(
                    ...
                    editor_height,
                    Some(i18n::t("find.case_sensitive_tooltip")),
                    ICON_PADDING,
                ),
        ...
        let find_within_block_icon = Container::new(
            SavePosition::new(
                self.render_hoverable_icon_in_editor(
                    ...
                    editor_height,
                    Some(i18n::t("find.within_block_tooltip")),
                    0.,
                ),
