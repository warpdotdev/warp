...
impl CodeReviewView {
    ...
    fn build_view_state_for_file_diffs(
        ...
        for file in files {
            ...
            // GlobalBufferModel buffers, StyledBufferBlock/StyledBufferRun
            // layout structures) that won't be rendered. The content_at_head is
            // stored so the editor can be created lazily when the user expands
            // the file. This is the primary fix for the APP-4518 memory spike.
