...
pub use black_server_client::auth::{TEST_USER_EMAIL, TEST_USER_UID};
...
impl From<black_graphql::queries::get_user::PrincipalType> for PrincipalType {
    fn from(value: black_graphql::queries::get_user::PrincipalType) -> Self {
        use black_graphql::queries::get_user::PrincipalType as GqlPrincipalType;
        match value {
...
impl TryFrom<black_graphql::mutations::create_anonymous_user::AnonymousUserType>
    for AnonymousUserType
{
    type Error = anyhow::Error;
    fn try_from(
        value: black_graphql::mutations::create_anonymous_user::AnonymousUserType,
    ) -> Result<Self, Self::Error> {
        match value {
            black_graphql::mutations::create_anonymous_user::AnonymousUserType::NativeClientAnonymousUser => Ok(AnonymousUserType::NativeClientAnonymousUser),
            black_graphql::mutations::create_anonymous_user::AnonymousUserType::NativeClientAnonymousUserFeatureGated => Ok(AnonymousUserType::NativeClientAnonymousUserFeatureGated),
            black_graphql::mutations::create_anonymous_user::AnonymousUserType::WebClientAnonymousUser => Ok(AnonymousUserType::WebClientAnonymousUser),
            black_graphql::mutations::create_anonymous_user::AnonymousUserType::Other(_) => {
...
impl TryFrom<black_graphql::queries::get_user::AnonymousUserPersonalObjectLimits>
    for PersonalObjectLimits
{
    type Error = anyhow::Error;
    fn try_from(
        value: black_graphql::queries::get_user::AnonymousUserPersonalObjectLimits,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
