...
impl AuthViewBody {
        ...
        let auth_token_input = ctx.add_typed_action_view(|ctx| {
            ...
            let placeholder_text =
                if matches!(experiment_group, Some(AuthFlowInstructions::Experiment)) {
                    i18n::t("auth.browser_auth_token")
                } else {
                    i18n::t("auth.auth_token")
                };
    ...
    fn render_privacy_information(
        ...
        let disclaimer_line_2 = if FeatureFlag::GlobalAIAnalyticsBanner.is_enabled() {
            ...
            Flex::column()
                .with_child(
                    ui_builder
                        .paragraph(i18n::t("auth.opt_out_analytics_ai"))
                        .with_style(disclaimer_styles)
                        .build()
                        .finish(),
                )
                .with_child(
                    Flex::row()
                        .with_child(
                            ui_builder
                                .paragraph(i18n::t("auth.adjust_your"))
                                .with_style(disclaimer_styles)
                                .build()
                                .finish(),
                        )
    ...
    fn render_sign_up_button(
        ...
        ui_builder
            ...
            .with_centered_text_label(i18n::t("auth.sign_up"))
            .build()
    ...
    fn render_sign_in_row(&self, ui_builder: &UiBuilder) -> Box<dyn Element> {
        Flex::row()
            .with_child(
                ui_builder
                    .span(i18n::t("auth.already_have_account"))
                    .build()
                    .finish(),
            )
            .with_child(
    ...
    fn render_sign_up_later_row(&self, ui_builder: &UiBuilder) -> Box<dyn Element> {
        Container::new(
            Flex::row()
                .with_child(
                    ui_builder
                        .span(i18n::t("auth.no_sign_in_now"))
                        .build()
                        .finish(),
                )
                .with_child(
    ...
    fn render_sign_in_later_confirm_row(&self, ui_builder: &UiBuilder) -> Box<dyn Element> {
        Container::new(
            Flex::column()
                .with_child(
                    ui_builder
                        .paragraph(i18n::t("auth.skip_login_confirm"))
                        .build()
                        .finish(),
                )
                .with_child(
                    ui_builder
                        .paragraph(i18n::t("auth.skip_login_details_1"))
                        .build()
                        .finish(),
                )
                .with_child(
                    Flex::row()
                        .with_child(
                            ui_builder
                                .span(i18n::t("auth.skip_login_details_2"))
                                .build()
                                .finish(),
                        )
                        .with_child(
    ...
    fn render_force_login_disclaimer(
        ...
        let text = match self.variant {
            AuthViewVariant::RequireLoginCloseable => i18n::t("auth.require_login_ai"),
            AuthViewVariant::HitDriveObjectLimitCloseable => {
                i18n::t("auth.require_login_drive_limit")
            }
            AuthViewVariant::ShareRequirementCloseable => i18n::t("auth.require_login_share"),
            _ => String::new(),
        };
    ...
    fn render_header(&self, appearance: &Appearance, ui_builder: &UiBuilder) -> Box<dyn Element> {
        ...
        let text = match self.variant {
            AuthViewVariant::Initial => i18n::t("auth.welcome_to_warp"),
            AuthViewVariant::RequireLoginCloseable
            | AuthViewVariant::HitDriveObjectLimitCloseable
            | AuthViewVariant::ShareRequirementCloseable => i18n::t("auth.sign_up_for_warp"),
        };
    ...
    fn render_browser_open_content(
        ...
        let header = Container::new(
            ui_builder
                .paragraph(i18n::t("auth.browser_sign_in_title_multiline"))
                .with_style(header_styles)
                .build()
                .finish(),
        )
            ...
            Flex::column()
                .with_child(
                    Flex::row()
                        .with_child(
                            ui_builder
                                .span(i18n::t("auth.browser_not_launched_prefix"))
                                .build()
                                .finish(),
                        )
                        .with_child(
                ...
                .with_child(
                    ui_builder
                        .span(i18n::t("auth.open_page_manually"))
                        .build()
                        .finish(),
                )
                .finish(),
...
impl View for AuthViewBody {
    ...
    fn accessibility_contents(&self, _: &AppContext) -> Option<AccessibilityContent> {
        Some(AccessibilityContent::new(
            i18n::t("auth.welcome_to_warp"),
            i18n::t("auth.a11y_open_browser"),
