...
mod warping_verb;
pub use warping_verb::{normalize_warping_verb, WarpingVerbSelector};
// Re-exported for tests and a planned Settings UI follow-up.
#[allow(unused_imports)]
pub use warping_verb::{DEFAULT_WARPING_VERB, MAX_CUSTOM_WARPING_VERBS, MAX_WARPING_VERB_CHARS};
