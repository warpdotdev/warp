...
use super::{
    ...
    default_collapsible_state_for_orchestration_message, open_recording_artifact_url,
...
#[test]
fn open_recording_artifact_url_prefers_view_url_and_falls_back_to_download_url() {
    let with_view_url: ArtifactDownloadResponse = serde_json::from_str(
        r#"{
            "artifact_uid": "recording-123",
            "artifact_type": "FILE",
            "created_at": "2024-01-15T10:30:00Z",
            "data": {
                "download_url": "https://storage.example.com/recording.mp4",
                "view_url": "https://oz.warp.dev/runs/run-123?artifact=recording-123",
                "expires_at": "2024-01-15T11:30:00Z",
                "content_type": "video/mp4",
                "filepath": "recordings/recording.mp4",
    ...
    .unwrap();
    assert_eq!(
        open_recording_artifact_url(&with_view_url),
        "https://oz.warp.dev/runs/run-123?artifact=recording-123"
    );

    let without_view_url: ArtifactDownloadResponse = serde_json::from_str(
        r#"{
            "artifact_uid": "recording-456",
            "artifact_type": "FILE",
            "created_at": "2024-01-15T10:30:00Z",
            "data": {
                "download_url": "https://storage.example.com/recording.mp4",
    ...
    .unwrap();
    assert_eq!(
        open_recording_artifact_url(&without_view_url),
