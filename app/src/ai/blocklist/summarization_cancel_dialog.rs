    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let cancel_button = Container::new(
            appearance
                ...
                .with_centered_text_label(i18n::t("ai.summarization.cancel"))
        ...
        let continue_button = appearance
            ...
            .with_centered_text_label(i18n::t("ai.summarization.continue"))
            .with_style(UiComponentStyles {
        ...
        let dialog_core = Dialog::new(
            i18n::t("ai.summarization.cancel_dialog.title"),
            Some(i18n::t("ai.summarization.cancel_dialog.body")),
            UiComponentStyles {
