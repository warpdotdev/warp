...
use black_ui::elements::{Align, Container, CrossAxisAlignment, Dismiss, Flex, ParentElement, Stack};
use black_ui::fonts::Weight;
use black_ui::keymap::FixedBinding;
use black_ui::platform::Cursor;
use black_ui::ui_components::button::ButtonVariant;
use black_ui::ui_components::components::{BorderStyle, Coords, UiComponent, UiComponentStyles};
...
impl View for SummarizationCancelDialog {
    ...
    fn on_focus(&mut self, _focus_ctx: &black_ui::FocusContext, ctx: &mut ViewContext<Self>) {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let esc_keystroke = black_ui::keymap::Keystroke::parse("escape").expect("Valid keystroke");
        ...
        stack.add_positioned_child(
            dialog_dismiss,
            black_ui::elements::OffsetPositioning::offset_from_parent(
                vec2f(0., 0.),
