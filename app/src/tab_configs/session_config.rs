...
pub fn build_tab_config(
    ...
    if enable_worktree {
        if autogenerate_worktree_branch_name {
            ...
            let worktree_path =
                build_shell_safe_worktree_path(directory, &autogenerated_branch_name, shell_family);
            ...
            let worktree_path =
                build_shell_safe_worktree_path(directory, &worktree_branch_name, shell_family);
            commands.push(format!(
