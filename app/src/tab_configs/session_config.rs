...
use super::tab_config::{
    generated_worktree_command_path, TabConfig, TabConfigPaneNode, TabConfigPaneType,
...
pub fn build_tab_config(
    ...
    if enable_worktree {
        if autogenerate_worktree_branch_name {
            ...
            let worktree_path =
                generated_worktree_command_path(directory, &worktree_branch_name, shell_family);
            commands.push(format!(
