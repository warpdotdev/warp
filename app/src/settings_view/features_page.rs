...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    let extra_meta_keys_left_text = if cfg!(target_os = "macos") {
        i18n::t("settings.features.extra_meta_keys.left_option")
    } else {
        i18n::t("settings.features.extra_meta_keys.left_alt")
    };
    let extra_meta_keys_right_text = if cfg!(target_os = "macos") {
        i18n::t("settings.features.extra_meta_keys.right_option")
    } else {
        i18n::t("settings.features.extra_meta_keys.right_alt")
    };

    let mut toggle_binding_pairs = vec![
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.copy_on_select_terminal"),
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.linux_selection_clipboard"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.autocomplete_symbols"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.restore_session"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.scroll_reporting"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.completions_while_typing"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.command_corrections"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.error_underlining"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.syntax_highlighting"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.audible_terminal_bell"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.autosuggestions"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.autosuggestion_keybinding_hint"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.autosuggestion_ignore_button"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    if !FeatureFlag::SSHTmuxWrapper.is_enabled() {
        toggle_binding_pairs.push(ToggleSettingActionPair::new(
            i18n::t("settings.features.action.warp_ssh_wrapper"),
            builder(SettingsAction::FeaturesPageToggle(
                #[allow(deprecated)]
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        i18n::t("settings.features.action.link_click_tooltip"),
        builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.long_running_command_notifications"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.agent_task_completion_notifications"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.needs_attention_notifications"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.notification_sounds"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.in_app_agent_notifications"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.quit_warning_modal"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.mouse_reporting"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.alias_expansion"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.middle_click_paste"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.code_default_editor"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.input_hint_text"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.vim_keybindings"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.vim_unnamed_register_clipboard"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.vim_status_bar"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.focus_reporting"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        i18n::t("settings.features.action.smart_select"),
        builder(SettingsAction::FeaturesPageToggle(
    ...
    if FeatureFlag::AgentView.is_enabled() && AISettings::as_ref(app).is_any_ai_enabled(app) {
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                i18n::t("settings.features.action.help_block_new_sessions"),
                builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.terminal_input_message_line"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.at_context_menu_terminal"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    if FeatureFlag::AgentView.is_enabled() && AISettings::as_ref(app).is_any_ai_enabled(app) {
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                i18n::t("settings.features.action.slash_commands_terminal"),
                builder(SettingsAction::FeaturesPageToggle(
    ...
    if FeatureFlag::AIContextMenuCode.is_enabled() {
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                i18n::t("settings.features.action.codebase_symbols_at_context"),
                builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.features.action.global_workflows_command_search"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    if GPUState::as_ref(app).is_low_power_gpu_available() {
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                i18n::t("settings.features.action.integrated_gpu_rendering_low_power"),
                builder(SettingsAction::FeaturesPageToggle(
    ...
    #[cfg(any(target_os = "linux", target_os = "freebsd"))]
    {
        if windowing_system_is_customizable(app) {
            toggle_binding_pairs.push(
                ToggleSettingActionPair::new(
                    i18n::t("settings.features.action.wayland_window_management"),
                    builder(SettingsAction::FeaturesPageToggle(
    ...
    app.register_fixed_bindings([FixedBinding::empty(
        i18n::t("settings.features.action.configure_global_hotkey"),
    ...
    if DefaultTerminal::can_warp_become_default() {
        app.register_fixed_bindings([FixedBinding::empty(
            i18n::t("settings.features.default_terminal.make_default"),
            builder(SettingsAction::FeaturesPageToggle(
...
fn block_maximum_rows_description() -> String {
    let max_rows = if ChannelState::enable_debug_features() {
        i18n::t("settings.features.block_limit.max_rows_10m")
    } else {
        i18n::t("settings.features.block_limit.max_rows_1m")
    };

    i18n::t("settings.features.block_limit.desc").replace("{max_rows}", &max_rows)
}
...
impl FeaturesPageView {
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
        ...
        let categories = vec![
            Category::new(
                Box::leak(i18n::t("settings.features.category.general").into_boxed_str()),
                general_widgets,
            ),
            Category::new(
                Box::leak(i18n::t("settings.features.category.session").into_boxed_str()),
                session_widgets,
            ),
            Category::new(
                Box::leak(i18n::t("settings.features.category.keys").into_boxed_str()),
                keys_widgets,
            ),
            Category::new(
                Box::leak(i18n::t("settings.features.category.text_editing").into_boxed_str()),
                text_editing_widgets,
            ),
            Category::new(
                Box::leak(i18n::t("settings.features.category.terminal_input").into_boxed_str()),
                editor_widgets,
            ),
            Category::new(
                Box::leak(i18n::t("settings.features.category.terminal").into_boxed_str()),
                terminal_widgets,
            ),
            Category::new(
                Box::leak(i18n::t("settings.features.category.notifications").into_boxed_str()),
                notifications_widgets,
            ),
            Category::new(
                Box::leak(i18n::t("settings.features.category.workflows").into_boxed_str()),
                vec![Box::new(WorkflowsInCommandSearch::default())],
            ),
            Category::new(
                Box::leak(i18n::t("settings.features.category.system").into_boxed_str()),
                system_widgets,
            ),
        ];
    ...
    fn new_tab_placement_dropdown_item_label(val: NewTabPlacement) -> String {
        match val {
            NewTabPlacement::AfterAllTabs => i18n::t("settings.features.new_tab.after_all_tabs"),
            NewTabPlacement::AfterCurrentTab => {
                i18n::t("settings.features.new_tab.after_current_tab")
            }
        }
    }
                ...
                Container::new(
                    Flex::row()
                        .with_child(
                            Container::new(
                                Text::new_inline(
                                    i18n::t("settings.features.quake.width_percent"),
                ...
                Container::new(
                    Flex::row()
                        .with_child(
                            Container::new(
                                Text::new_inline(
                                    i18n::t("settings.features.quake.height_percent"),
                                    appearance.ui_font_family(),
                                    appearance.ui_font_size(),
                                )
                                .with_color(theme.active_ui_text_color().into())
        ...
        Container::new(
            Flex::row()
                ...
                .with_child(
                    appearance
                        .ui_builder()
                        .span(i18n::t("settings.features.quake.autohide_on_blur"))
                        .build()
                        .with_margin_left(5.)
                        .finish(),
                )
        ...
        Flex::row()
            ...
            .with_child(
                Container::new(
                    Align::new(
                        Text::new_inline(
                            i18n::t("settings.features.notifications.long_running_prefix"),
                            appearance.ui_font_family(),
                            font_size,
                        )
            ...
            .with_child(
                Container::new(
                    Align::new(
                        Text::new_inline(
                            i18n::t("settings.features.notifications.long_running_suffix"),
                            appearance.ui_font_family(),
                            font_size,
                        )
                        .with_color(font_color.into())
            ...
            Flex::row()
                ...
                .with_child(
                    Shrinkable::new(
                        ...
                        Align::new(
                            Text::new_inline(
                                i18n::t("settings.features.keybinding.label"),
                                appearance.ui_font_family(),
                                13.,
                            )
                ...
                .with_child(
                    Shrinkable::new(
                        ...
                        Align::new(if let Some(keybinding) = &keybinding.unsaved_binding {
                            ...
                            appearance
                                .ui_builder()
                                .paragraph(i18n::t("settings.features.keybinding.click_to_set"))
                                .build()
                                .finish()
                        })
                        .finish(),
    ...
    fn render_clicked<T: Fn(&mut EventContext, Keystroke) + 'static>(
        ...
        let cancel_button = appearance
            ...
            .with_text_label(i18n::t("settings.features.button.cancel"))
            .build()
            .on_click(move |ctx, _, _| {
        ...
        let save_button = Shrinkable::new(
            ...
            appearance
                ...
                .with_text_label(i18n::t("settings.features.button.save"))
                .build()
                .on_click(move |ctx, _, _| {
                    ...
                    Flex::row()
                        .with_child(
                            Shrinkable::new(
                                ...
                                Align::new(
                                    Text::new_inline(
                                        i18n::t("settings.features.keybinding.press_new_shortcut"),
                                        appearance.ui_font_family(),
                                        13.,
                                    )
                                    .with_color(appearance.theme().active_ui_text_color().into())
    ...
    fn render_change_keybinding_button(
        ...
        Hoverable::new(
            ...
            |state| {
                ...
                Container::new(
                    Text::new_inline(
                        i18n::t("settings.features.keybinding.change"),
                        appearance.ui_font_family(),
                        12.,
                    )
...
fn init_display_count_dropdown(
    ...
    let no_preference = DropdownItem::new(
        i18n::t("settings.features.quake.active_screen"),
        //|| {
    ...
    match quake_mode_settings.pin_screen {
        ...
        _ => dropdown.set_selected_by_name(i18n::t("settings.features.quake.active_screen"), ctx),
    };
}
...
impl SettingsWidget for NativeRedirectWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.open_links_desktop.label"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(i18n::t(
                    "settings.features.open_links_desktop.tooltip",
                )),
            }),
...
impl SettingsWidget for SessionRestorationWidget {
    ...
    fn render(
        ...
        let labeled_switch = render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.restore_session.label"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
        ...
        if app.is_wayland() {
            let message = Text::new_inline(
                i18n::t("settings.features.restore_session.wayland_warning"),
                appearance.ui_font_family(),
                CONTENT_FONT_SIZE,
            )
            ...
            let link = ui_builder
                .link(
                    i18n::t("settings.features.see_docs"),
...
impl SettingsWidget for SnackbarHeaderWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.sticky_command_header.label"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for LinkTooltipWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.link_tooltip.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for QuitWarningModalWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.quit_warning.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for LoginItemWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        #[cfg(target_os = "macos")]
        let label = i18n::t("settings.features.login_item.label_macos");
        #[cfg(not(target_os = "macos"))]
        let label = i18n::t("settings.features.login_item.label");
        render_body_item::<FeaturesPageAction>(
            label,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for QuitWhenAllWindowsClosedWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.quit_all_windows.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowChangelogWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.show_changelog.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for MouseScrollMultiplierWidget {
    ...
    fn render(
            ...
            .with_children([
                ...
                if view.valid_mouse_scroll_multiplier {
                    ...
                    appearance
                        .ui_builder()
                        .wrappable_text(
                            i18n::t("settings.features.mouse_scroll.allowed_values"),
                            true,
                        )
                        .with_style(UiComponentStyles {
        ...
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.mouse_scroll.label"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(i18n::t("settings.features.mouse_scroll.tooltip")),
            }),
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AutoOpenCodeReviewPaneWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.auto_open_code_review.label"),
            None,
            LocalOnlyIconState::for_setting(
            ...
            ui_builder
                ...
                .finish(),
            Some(i18n::t("settings.features.auto_open_code_review.desc")),
        )
    }
}
...
impl SettingsWidget for DefaultTerminalWidget {
    ...
    fn render(
        ...
        if default_terminal.is_warp_default() {
            ui_builder
                .wrappable_text(
                    i18n::t("settings.features.default_terminal.is_default"),
                    true,
                )
                .with_style(UiComponentStyles {
...
impl SettingsWidget for BlockLimitWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.block_limit.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for SSHWrapperWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.ssh_wrapper.label"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
                ...
                secondary_text: if view.ssh_wrapper_toggled {
                    Some(i18n::t(
                        "settings.features.ssh_wrapper.takes_effect_new_sessions",
                    ))
                } else {
                    None
                },
...
impl SettingsWidget for DesktopNotificationsWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.notifications.receive_desktop"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
        ...
        if matches!(
            ...
            let agent_task_completed_label =
                i18n::t("settings.features.notifications.agent_task_completed");
            let needs_attention_label = i18n::t("settings.features.notifications.needs_attention");
            let toggles = vec![
                view.render_notification_toggle(
                    session_settings
                        .notifications
                        .is_agent_task_completed_enabled,
                    &agent_task_completed_label,
                    FeaturesPageAction::ToggleAgentTaskCompletedNotifications,
                ...
                #[cfg(target_os = "macos")]
                {
                    let play_sounds_label = i18n::t("settings.features.notifications.play_sounds");
                    view.render_notification_toggle(
        ...
        if FeatureFlag::HOANotifications.is_enabled() {
            ...
            column.add_child(render_body_item::<FeaturesPageAction>(
                i18n::t("settings.features.notifications.in_app_agent"),
                None,
            ...
            if show_agent_notifications {
                ...
                let toast_duration_row = Flex::row()
                    ...
                    .with_child(
                        Text::new_inline(
                            i18n::t("settings.features.notifications.toast_duration_prefix"),
                            appearance.ui_font_family(),
                            font_size,
                        )
                        .with_color(font_color.into())
                    ...
                    .with_child(
                        Text::new_inline(
                            i18n::t("settings.features.notifications.toast_duration_suffix"),
                            appearance.ui_font_family(),
                            font_size,
                        )
                        .with_color(font_color.into())
        ...
        Flex::column()
            .with_children([
                render_sub_sub_header(
                    appearance,
                    i18n::t("settings.features.startup_shell.header"),
    ...
    fn render(
        ...
        Flex::column()
            .with_children([
                render_sub_sub_header(
                    appearance,
                    i18n::t("settings.features.working_directory.header"),
                    Some(LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ConfirmCloseSharedSessionWidget {
    ...
    fn render(
        ...
        let session_settings = SessionSettings::as_ref(app);
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.confirm_close_shared.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for GlobalHotkeyWidget {
    ...
    fn render(
        ...
        if app.is_wayland() {
            column.add_child(render_body_item::<FeaturesPageAction>(
                i18n::t("settings.features.global_hotkey.label"),
                None,
                ...
                Flex::row()
                    .with_children([
                        ui_builder
                            .span(i18n::t(
                                "settings.features.global_hotkey.not_supported_wayland",
                            ))
                            .build()
                            .finish(),
                        ui_builder
            ...
            add_setting(
                ...
                || {
                    let global_hotkey_label = i18n::t("settings.features.global_hotkey.label");
...
impl SettingsWidget for AutocompleteSymbolsWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.autocomplete_symbols.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CodeEditorLineNumberModeWidget {
    ...
    fn render(
        ...
        add_setting(
            ...
            || {
                let line_numbers_label = i18n::t("settings.features.code_line_numbers.label");
                render_dropdown_item(
                    appearance,
                    &line_numbers_label,
                    None,
...
impl SettingsWidget for ErrorUnderliningWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.error_underlining.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for SyntaxHighlightingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.syntax_highlighting.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CompletionsMenuWhileTypingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.completions_while_typing.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CommandCorrectionsWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.command_corrections.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AliasExpansionWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.alias_expansion.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for MiddleClickPasteWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.middle_click_paste.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for VimModeWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.vim_mode.label"),
            None,
            LocalOnlyIconState::for_setting(
        ...
        if vim_mode_enabled {
            ...
            let clipboard_setting = view.render_setting_subgroup_item(
                ...
                clipboard_switch,
                i18n::t("settings.features.vim_unnamed_clipboard.label"),
            );
            ...
            let status_bar_setting = view.render_setting_subgroup_item(
                ...
                status_bar_switch,
                i18n::t("settings.features.vim_status_bar.label"),
            );
...
impl SettingsWidget for AtContextMenuInTerminalModeWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.at_context_menu.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for SlashCommandsInTerminalModeWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.slash_commands.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for OutlineCodebaseSymbolsForAtContextMenuWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.outline_codebase_symbols.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowTerminalInputMessageLineWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.terminal_input_message_line.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AutosuggestionKeybindingHintWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.autosuggestion_hint.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AutosuggestionIgnoreButtonWidget {
    ...
    fn render(
        ...
        let show_autosuggestion_ignore_button = *app_editor_settings
            ...
            .value();
        column.add_child(render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.autosuggestion_ignore_button.label"),
            None,
            LocalOnlyIconState::for_setting(
    ...
    fn render_tab_behavior_setting_secondary_row(
        ...
        let other_keybinding_info = match *view.tab_behavior {
            TabBehavior::Completions if view.autosuggestions_keystroke.is_empty() => {
                ...
                Some(i18n::t(
                    "settings.features.tab_behavior.arrow_accepts_autosuggestions",
                ))
            }
            TabBehavior::Completions => Some(
                i18n::t("settings.features.tab_behavior.key_accepts_autosuggestions")
                    .replace("{key}", &view.autosuggestions_keystroke.to_string()),
            ),
            TabBehavior::Autosuggestions
                if *input_settings.completions_open_while_typing.value() =>
            {
                if view.completions_keystroke.is_empty() {
                    Some(i18n::t(
                        "settings.features.tab_behavior.completions_open_typing",
                    ))
                } else {
                    Some(
                        i18n::t("settings.features.tab_behavior.completions_open_typing_or_key")
                            .replace("{key}", &view.completions_keystroke.to_string()),
                    )
                }
            }
            TabBehavior::Autosuggestions if view.completions_keystroke.is_empty() => Some(i18n::t(
                "settings.features.tab_behavior.completion_menu_unbound",
            )),
            TabBehavior::Autosuggestions => Some(
                i18n::t("settings.features.tab_behavior.key_opens_completion_menu")
                    .replace("{key}", &view.completions_keystroke.to_string()),
            ),
    ...
    fn render(
        ...
        let mut tab_key_span = Flex::row()
            ...
            .with_child(
                appearance
                    .ui_builder()
                    .span(i18n::t("settings.features.tab_behavior.header"))
                    .with_style(UiComponentStyles {
...
impl SettingsWidget for CtrlTabBehaviorWidget {
    ...
    fn render(
        ...
        add_setting(
            ...
            || {
                let ctrl_tab_label = i18n::t("settings.features.ctrl_tab_behavior.label");
                render_dropdown_item(
                    appearance,
                    &ctrl_tab_label,
                    None,
...
impl SettingsWidget for MouseReportingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.mouse_reporting.label"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for ScrollReportingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.scroll_reporting.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for FocusReportingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.focus_reporting.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AudibleBellWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.audible_bell.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SmartSelectWidget {
    fn render_word_char_config(
        ...
        Flex::column()
            .with_child(
                ui_builder
                    .label(i18n::t("settings.features.smart_select.word_chars_label"))
                    .with_style(UiComponentStyles {
                        margin: Some(Coords {
                            top: 10.0,
                            bottom: 5.0,
...
impl SettingsWidget for SmartSelectWidget {
    ...
    fn render(
        ...
        let mut column = Flex::column();
        column.add_child(render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.smart_select.label"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for ShowTerminalZeroStateBlockWidget {
    ...
    fn render(
        ...
        let terminal_settings = TerminalSettings::as_ref(app);
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.help_block.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CopyOnSelectWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.copy_on_select.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for NewTabPlacementWidget {
    ...
    fn render(
        ...
        let new_tab_placement_label = i18n::t("settings.features.new_tab.placement_label");
        render_dropdown_item(
            appearance,
...
impl SettingsWidget for DefaultSessionModeWidget {
    ...
    fn render(
        ...
        let label = render_dropdown_item_label(
            i18n::t("settings.features.default_session_mode.label"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for WorkflowsInCommandSearch {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.global_workflows.label"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for LinuxSelectionClipboardWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.linux_clipboard.label"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(i18n::t("settings.features.linux_clipboard.tooltip")),
            }),
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for GPUWidget {
    ...
    fn render(
        ...
        let mut col = Flex::column().with_child(render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.gpu.prefer_low_power.label"),
            None,
            LocalOnlyIconState::for_setting(
            ...
            col.add_child(
                Container::new(
                    appearance
                        .ui_builder()
                        .wrappable_text(
                            i18n::t("settings.features.changes_apply_new_windows"),
                            true,
                        )
                        .with_style(UiComponentStyles {
...
impl SettingsWidget for WindowSystemWidget {
    ...
    fn render(
        ...
        children.add_child(render_body_item::<FeaturesPageAction>(
            i18n::t("settings.features.wayland.label"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(i18n::t("settings.features.wayland.tooltip")),
            }),
            LocalOnlyIconState::for_setting(
        ...
        let mut secondary_text = i18n::t("settings.features.wayland.secondary_text");
        if view.force_x11_changed {
            secondary_text.push('\n');
            secondary_text.push('\n');
            secondary_text.push_str(&i18n::t("settings.features.wayland.restart_required"));
        }
...
impl SettingsWidget for GraphicsBackendWidget {
    ...
    fn render(
        ...
        let theme = appearance.theme();
        let graphics_backend_label = i18n::t("settings.features.graphics_backend.label");
        let dropdown = render_dropdown_item(
            appearance,
            &graphics_backend_label,
            None,
            None,
            LocalOnlyIconState::for_setting(
        ...
        if let Some(window) = app.windows().platform_window(view.window_id) {
            ...
            col.add_child(
                appearance
                    .ui_builder()
                    .wrappable_text(
                        i18n::t("settings.features.graphics_backend.current")
...
impl SettingsWidget for AsyncFindWidget {
    ...
    fn render(
        ...
        let label = render_body_item_label::<FeaturesPageAction>(
            i18n::t("settings.features.async_find.label"),
            None,
            None,
            LocalOnlyIconState::for_setting(
        ...
        build_toggle_element(
            ...
            switch,
            appearance,
            Some(i18n::t("settings.features.async_find.desc")),
        )
    }
}
