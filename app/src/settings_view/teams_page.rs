...
fn team_name_editor_placeholder_text() -> &'static str {
    crate::menu_label("settings.teams.team_name", "Team name")
}
fn create_team_description() -> &'static str {
    crate::menu_label(
        "settings.teams.create_team_description",
...
fn leave_team_button_label() -> &'static str {
    crate::menu_label("settings.teams.leave_team", "Leave team")
}
fn delete_team_button_label() -> &'static str {
    crate::menu_label("settings.teams.delete_team", "Delete team")
}
fn create_team_button_label() -> &'static str {
    crate::menu_label("settings.teams.create", "Create")
}
fn approve_domains_placeholder() -> &'static str {
    crate::menu_label(
        "settings.teams.domains_comma_separated",
        "Domains, comma separated",
    )
}
fn emails_placeholder() -> &'static str {
    crate::menu_label(
        "settings.teams.emails_comma_separated",
        "Emails, comma separated",
    )
}
fn approve_domains_button_label() -> &'static str {
    crate::menu_label("settings.teams.set", "Set")
}
fn send_email_invites_button_label() -> &'static str {
    crate::menu_label("settings.teams.invite", "Invite")
}
fn invalid_domains_instructions() -> &'static str {
    crate::menu_label(
        "settings.teams.invalid_domains_instructions",
        "Some of the provided domains are invalid, or have already been added.",
    )
}
fn invite_link_toggle_instructions() -> &'static str {
    crate::menu_label(
        "settings.teams.invite_link_toggle_instructions",
        "As an admin, you can choose whether to enable or disable the ability for team members to invite others by invitation link.",
    )
}
fn invite_link_domain_restrictions_instructions() -> &'static str {
    crate::menu_label(
        "settings.teams.invite_link_domain_restrictions_instructions",
        "Restrict by domain — only allow users with emails at specific domains to join your team through the invite link.",
    )
}
fn invite_by_email_expiry_instructions() -> &'static str {
    crate::menu_label(
        "settings.teams.email_invite_expiry_instructions",
        "Email invitations are valid for 7 days.",
    )
}
fn invalid_emails_instructions() -> &'static str {
    crate::menu_label(
        "settings.teams.invalid_emails_instructions",
        "Some of the provided email addresses are invalid, already invited, or members of the team.",
    )
}
fn offline_text() -> &'static str {
    crate::menu_label("settings.teams.offline", "You are offline.")
}
// ───────────────────────────────────────────────────────────────────────
...
impl std::fmt::Display for TeamsInviteOption {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            ...
            "{}",
            match self {
                TeamsInviteOption::Link => crate::menu_label("settings.teams.invite_option_link", "Link"),
                TeamsInviteOption::Email => crate::menu_label(
                    "settings.teams.invite_option_email",
                    "Email"
                ),
            },
        )
...
impl TeamsPageView {
    ...
    pub fn new(ctx: &mut ViewContext<TeamsPageView>) -> Self {
        ...
        let rename_team_editor = ctx.add_typed_action_view(|ctx| {
            ...
            input.set_placeholder_text(crate::menu_label("settings.teams.your_new_team_name", "Your new team name"), ctx);
            input
        });
        ...
        let transfer_ownership_modal = ctx.add_typed_action_view(|ctx| {
            Modal::new(
                Some(crate::menu_label("settings.teams.transfer_team_ownership", "Transfer team ownership?").to_string()),
    ...
    fn handle_model_event(
        ...
        match event {
            ...
            UserWorkspacesEvent::EmailInviteRejected(err) => {
                ...
                self.show_error(
                    crate::menu_label(
                        "settings.teams.failed_to_send_invite",
            ...
            UserWorkspacesEvent::ToggleInviteLinksSuccess => {
                self.show_success(
                    crate::menu_label(
                        "settings.teams.toggled_invite_links",
                        "Toggled invite links",
                    ),
                    ctx,
                );
                ctx.notify();
            ...
            UserWorkspacesEvent::ToggleInviteLinksRejected(err) => {
                self.show_error(
                    crate::menu_label(
                        "settings.teams.failed_to_toggle_invite_links",
                        "Failed to toggle invite links",
                    ),
                    Some(err),
                    ctx,
                );
            ...
            UserWorkspacesEvent::ResetInviteLinks => {
                self.show_success(
                    crate::menu_label(
                        "settings.teams.reset_invite_links_success",
                        "Reset invite links",
                    ),
                    ctx,
                );
            ...
            UserWorkspacesEvent::ResetInviteLinksRejected(err) => {
                self.show_error(
                    crate::menu_label(
                        "settings.teams.failed_to_reset_invite_links",
                        "Failed to reset invite links",
                    ),
                    Some(err),
                    ctx,
                );
            ...
            UserWorkspacesEvent::DeleteTeamInvite => {
                self.update_team_members_state(ctx);
                self.show_success(
                    crate::menu_label("settings.teams.deleted_invite", "Deleted invite"),
                    ctx,
                );
            }
            UserWorkspacesEvent::DeleteTeamInviteRejected(err) => {
                self.show_error(
                    crate::menu_label(
                        "settings.teams.failed_to_delete_invite",
            ...
            UserWorkspacesEvent::AddDomainRestrictionsRejected(err) => {
                self.show_error(
                    crate::menu_label(
                        "settings.teams.failed_to_add_domain_restriction",
                        "Failed to add domain restriction",
                    ),
                    Some(err),
                    ctx,
                )
            ...
            UserWorkspacesEvent::DeleteDomainRestrictionRejected(err) => {
                self.show_error(
                    crate::menu_label(
                        "settings.teams.failed_to_delete_domain_restriction",
                        "Failed to delete domain restriction",
                    ),
                    Some(err),
                    ctx,
                )
            ...
            UserWorkspacesEvent::GenerateUpgradeLinkRejected(err) => self.show_error(
                crate::menu_label(
                    "settings.teams.failed_to_generate_upgrade_link",
            ...
            UserWorkspacesEvent::GenerateStripeBillingPortalLinkRejected(err) => self.show_error(
                crate::menu_label(
                    "settings.teams.failed_to_generate_billing_link",
            ...
            UserWorkspacesEvent::ToggleTeamDiscoverabilitySuccess => {
                self.show_success(
                    crate::menu_label(
                        "settings.teams.toggled_team_discoverability",
            ...
            UserWorkspacesEvent::ToggleTeamDiscoverabilityRejected(err) => {
                self.show_error(
                    crate::menu_label(
                        "settings.teams.failed_to_toggle_team_discoverability",
            ...
            UserWorkspacesEvent::JoinTeamWithTeamDiscoverySuccess => {
                ...
                let message = self
                    ...
                    .map_or_else(
                        || {
                            crate::menu_label(
                                "settings.teams.successfully_joined_team",
                        ...
                        |team| {
                            i18n::interpolate(
                                crate::menu_label(
                                    "settings.teams.successfully_joined_team_named",
            ...
            UserWorkspacesEvent::JoinTeamWithTeamDiscoveryRejected(err) => {
                self.show_error(
                    crate::menu_label(
                        "settings.teams.failed_to_join_team",
                        "Failed to join team",
                    ),
                    Some(err),
                    ctx,
            ...
            UserWorkspacesEvent::TransferTeamOwnershipSuccess => {
                self.show_success(
                    crate::menu_label(
                        "settings.teams.successfully_transferred_team_ownership",
            ...
            UserWorkspacesEvent::TransferTeamOwnershipRejected(err) => {
                self.show_error(
                    crate::menu_label(
                        "settings.teams.failed_to_transfer_team_ownership",
            ...
            UserWorkspacesEvent::SetTeamMemberRoleSuccess => {
                ...
                self.show_success(
                    crate::menu_label(
                        "settings.teams.successfully_updated_team_member_role",
            ...
            UserWorkspacesEvent::SetTeamMemberRoleRejected(err) => {
                self.show_error(
                    crate::menu_label(
                        "settings.teams.failed_to_update_team_member_role",
    ...
    fn handle_team_update_event(
        ...
        match event {
            TeamUpdateManagerEvent::LeaveError => {
                let error = crate::menu_label(
                    "settings.teams.error_leaving_team",
                    "Error leaving team",
                )
                .to_string();
            ...
            TeamUpdateManagerEvent::LeaveSuccess => {
                self.show_success(
                    crate::menu_label(
                        "settings.teams.successfully_left_team",
            ...
            TeamUpdateManagerEvent::RenameTeamSuccess => {
                self.show_success(
                    crate::menu_label(
                        "settings.teams.successfully_renamed_team",
                        "Successfully renamed team",
                    ),
                    ctx,
                )
            }
            TeamUpdateManagerEvent::RenameTeamError => {
                self.show_error(
                    crate::menu_label(
                        "settings.teams.failed_to_rename_team",
    ...
    fn copy_invite_link(&mut self, link: &str, ctx: &mut ViewContext<Self>) {
        ...
        self.show_toast(
            crate::menu_label(
                "settings.teams.link_copied_to_clipboard",
    ...
    fn add_domain_restrictions(&mut self, team_uid: ServerId, ctx: &mut ViewContext<Self>) {
        ...
        if !invalid_domains.is_empty() {
            let error = i18n::interpolate(
                crate::menu_label(
                    "settings.teams.invalid_domains_count",
        ...
        let success_message = i18n::interpolate(
            crate::menu_label(
                "settings.teams.domain_restrictions_added_count",
                "Domain restrictions added: {count}",
            ),
            &[("count", unique_domains.len().to_string())],
        )
        .into_owned();
        self.show_success(success_message, ctx);
        self.user_workspaces
            .update(ctx, move |user_workspaces, ctx| {
    ...
    fn send_email_invites(&mut self, team_uid: ServerId, ctx: &mut ViewContext<Self>) {
        ...
        if !invalid_emails.is_empty() {
            let error = i18n::interpolate(
                crate::menu_label(
                    "settings.teams.invalid_emails_count",
        ...
        let message = if unique_emails.len() == 1 {
            crate::menu_label(
                "settings.teams.invite_on_its_way",
            ...
            i18n::interpolate(
                crate::menu_label(
                    "settings.teams.invites_on_their_way",
            ...
            if member.email != *current_user_email {
                ...
                if current_user_has_owner_permissions && !team_member_has_owner_permissions {
                    actions.push(ItemAction {
                        icon: Icon::Users,
                        label: crate::menu_label(
                            "settings.teams.transfer_ownership",
                            "Transfer ownership",
                        )
                        .to_string(),
                    ...
                    && !team_member_has_owner_permissions
                {
                    if team_member_has_admin_permissions {
                        actions.push(ItemAction {
                            icon: Icon::ArrowDown,
                            label: crate::menu_label(
                                "settings.teams.demote_from_admin",
                                "Demote from admin",
                            )
                            .to_string(),
                        ...
                        actions.push(ItemAction {
                            icon: Icon::ArrowUp,
                            label: crate::menu_label(
                                "settings.teams.promote_to_admin",
                                "Promote to admin",
                            )
                            .to_string(),
                            action: TeamsPageAction::SetTeamMemberRole {
                ...
                if current_user_has_admin_permissions && !team_member_has_owner_permissions {
                    actions.push(ItemAction {
                        icon: Icon::X,
                        label: crate::menu_label(
                            "settings.teams.remove_from_team",
                            "Remove from team",
                        )
                        .to_string(),
...
impl TeamsWidget {
    ...
    fn render_grow_team_warning_alert(
        ...
        let title = match warning {
            GrowTeamWarning::SeatCapReached => {
                crate::menu_label("settings.teams.team_full_title", "Your team is full")
            }
            GrowTeamWarning::SeatCapExceeded => {
                crate::menu_label("settings.teams.you_exceeded_member_limit", "You've exceeded your member limit")
            }
            GrowTeamWarning::PaymentPastDue => {
                crate::menu_label("settings.teams.payment_past_due", "Payment past due")
            }
            GrowTeamWarning::PaymentUnpaid => {
                crate::menu_label("settings.teams.subscription_unpaid", "Subscription unpaid")
            }
        };
        ...
        let body_prefix = match warning {
            GrowTeamWarning::SeatCapReached => {
                crate::menu_label("settings.teams.seat_cap_reached", "You've reached your plan's member limit.")
            }
            GrowTeamWarning::SeatCapExceeded => {
                crate::menu_label("settings.teams.seat_cap_exceeded", "You've exceeded your plan's member limit. Existing team members keep their access, but you won't be able to add new members.")
            }
            GrowTeamWarning::PaymentPastDue => {
                crate::menu_label("settings.teams.payment_past_due_description", "Team invites have been restricted due to a past-due payment.")
            }
            GrowTeamWarning::PaymentUnpaid => {
                crate::menu_label("settings.teams.subscription_unpaid_description", "Team invites have been restricted due to an unpaid subscription.")
            }
        };
        ...
        let cta_sentence = if !has_admin_permissions {
            if is_delinquency {
                crate::menu_label(
                    "settings.teams.contact_team_admin_to_restore",
                    "Contact a team admin to restore access.",
                )
            } else {
                crate::menu_label(
                    "settings.teams.contact_team_admin_to_grow",
                    "Contact a team admin to grow the team.",
                )
            }
        } else {
            match cta {
                GrowTeamWarningCta::Upgrade => crate::menu_label(
                    "settings.teams.upgrade_to_grow_team",
                    "Upgrade to grow your team.",
                ),
                GrowTeamWarningCta::UpdateBilling => crate::menu_label(
                    "settings.teams.update_payment_to_restore",
                    "Update your payment information to restore access.",
                ),
                GrowTeamWarningCta::ContactSupport => crate::menu_label(
                    "settings.teams.contact_support_to_restore",
                ...
                GrowTeamWarningCta::None => {
                    if is_delinquency {
                        ...
                        crate::menu_label(
                            "settings.teams.contact_sales_to_grow",
    ...
    fn outgrow_upgrade_line_copy(
        ...
        if billing_metadata.customer_type == CustomerType::Business {
            (
                crate::menu_label(
                    "settings.teams.upgrade_to_enterprise",
                    "Upgrade to Enterprise",
                ),
                crate::menu_label(
                    "settings.teams.for_unlimited_team_member_limit",
            ...
            (
                crate::menu_label(
                    "settings.teams.upgrade_to_business",
                    "Upgrade to Business",
                ),
                crate::menu_label(
                    "settings.teams.for_higher_team_member_limit",
    ...
    fn render_team_member_cost_info(
        ...
        let prorated_message = if has_admin_permissions {
            crate::menu_label(
                "settings.teams.prorated_charge_info",
                "You'll be charged for a portion of the team member's usage of Warp.",
            )
        } else {
            crate::menu_label(
                "settings.teams.prorated_charge_info_admin",
            ...
            self.get_per_seat_costs(team_metadata, pricing_info_model)
        {
            i18n::interpolate(
                crate::menu_label(
                    "settings.teams.additional_members_billed",
                    "Additional members are billed at your plan's per-user rate: ${monthly:.0}/month or ${yearly:.0}/year, depending on your billing interval. {prorated}",
                ),
                &[
                    ("monthly", format!("{monthly_cost:.0}")),
                    ("yearly", format!("{yearly_cost:.0}")),
                    ("prorated", prorated_message.to_string()),
                ],
            )
            .into_owned()
        } else {
            i18n::interpolate(
                crate::menu_label(
                    "settings.teams.additional_members_billed_no_rate",
                    "Additional members are billed at your plan's per-user rate. {prorated}",
                ),
                &[("prorated", prorated_message.to_string())],
            )
            .into_owned()
        ...
        match team.billing_metadata.delinquency_status {
            ...
            DelinquencyStatus::Unpaid => {
                left_side.add_child(
                    Container::new(self.render_delinquency_badge(
                        appearance,
                        crate::menu_label("settings.teams.unpaid", "UNPAID").into(),
    ...
    fn render_manage_billing_button(
        ...
        appearance
            ...
            .with_text_and_icon_label(
                TextAndIcon::new(
                    TextAndIconAlignment::IconFirst,
                    crate::menu_label("settings.teams.manage_billing", "Manage billing"),
    ...
    fn render_admin_panel_button(
        ...
        appearance
            ...
            .with_text_and_icon_label(
                TextAndIcon::new(
                    TextAndIconAlignment::IconFirst,
                    crate::menu_label("settings.teams.open_admin_panel", "Open admin panel"),
        ...
        if team.billing_metadata.customer_type == CustomerType::Enterprise {
            ...
            if team.billing_metadata.can_upgrade_to_higher_tier_plan() {
                let description = if team.billing_metadata.can_upgrade_to_build_plan() {
                    crate::menu_label("settings.teams.upgrade_to_build", "Upgrade to Build")
                } else {
                    match team.billing_metadata.customer_type {
                        ...
                        _ => crate::menu_label("settings.teams.compare_plans", "Compare plans"),
                    }
                };
                billing_links.add_child(
    ...
    fn render_plan_usage(
        ...
        let sub_header_text = match team.billing_metadata.customer_type {
            CustomerType::Free => {
                crate::menu_label("settings.teams.free_plan_usage_limits", "Free plan usage limits")
            }
            _ => crate::menu_label("settings.teams.plan_usage_limits", "Plan usage limits"),
        };
    ...
    fn render_team_invitation_section(
        ...
        invitation_section.add_child(
            Container::new(
                self.render_subsection_header(crate::menu_label("settings.teams.invite_team_members", "Invite team members").to_owned(), appearance),
            )
    ...
    fn render_invite_by_link_section(
        ...
        let header = self.render_subsubsection_header(crate::menu_label("settings.teams.by_link", "By link").to_owned(), appearance);
        let text_column = if has_admin_permissions {
            Flex::column()
                .with_child(header)
                .with_child(
                    Container::new(self.render_sub_text(
                        invite_link_toggle_instructions().to_string(),
                        appearance,
                ...
                section.add_child(
                    Align::new(
                        appearance
                            .ui_builder()
                            .link(
                                crate::menu_label("settings.teams.reset_links", "Reset links").into(),
                                None,
    ...
    fn render_invite_by_email_section(
        ...
        section.add_child(
            Container::new(self.render_subsubsection_header(crate::menu_label("settings.teams.by_email", "By email").to_owned(), appearance))
                .with_padding_top(CONTENT_SEPARATION_PADDING)
        ...
        section.add_child(
            Container::new(self.render_sub_text(
                invite_by_email_expiry_instructions().to_string(),
                appearance,
                Some(Coords::uniform(0.).right(48.)),
            ))
            ...
            && view.email_invites_block_editor_state.num_chips > 0
        {
            section.add_child(
                Container::new(
                    self.render_error_sub_text(invalid_emails_instructions().to_string(), appearance),
                )
                .with_padding_top(8.)
                .finish(),
            )
    ...
    fn render_team_members_section(
        ...
        let header_row = Flex::row()
            ...
            .with_main_axis_alignment(MainAxisAlignment::SpaceBetween)
            .with_cross_axis_alignment(CrossAxisAlignment::Center)
            .with_child(self.render_subsection_header(crate::menu_label("settings.teams.team_members", "Team members").to_owned(), appearance))
    ...
    fn render_team_members_count(&self, team: &Team, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let count_label = if count == 1 {
            crate::menu_label("settings.teams.team_member_count_one", "1 team member").to_string()
        } else {
            i18n::interpolate(
                crate::menu_label(
                    "settings.teams.team_member_count_other",
                    "{count} team members",
                ),
        ...
        let tooltip_text = i18n::interpolate(
            crate::menu_label(
                "settings.teams.member_limit_info",
                "Your plan ({plan}) has a maximum capacity of {cap} members.",
            ),
            &[("plan", plan_display.to_string()), ("cap", cap.to_string())],
        )
        .into_owned();
    ...
    fn render_outgrow_upgrade_cta(
        ...
        let prefix = self.render_sub_text(
            crate::menu_label("settings.teams.need_more_seats", "Need more seats? ").to_string(),
            appearance,
            None,
        );
        let link = appearance
    ...
    fn render_approved_domains_section(
        ...
        if has_admin_permissions {
            section.add_child(
                Container::new(self.render_sub_text(
                    invite_link_domain_restrictions_instructions().to_string(),
                    appearance,
                    Some(Coords::uniform(0.).right(48.)),
                ))
                .with_padding_top(16.)
                ...
                && view.approve_domains_block_editor_state.num_chips > 0
            {
                section.add_child(
                    Container::new(
                        self.render_error_sub_text(invalid_domains_instructions().to_string(), appearance),
                    )
                    .with_padding_top(8.)
                    .finish(),
                )
        ...
        let domains_as_items: Vec<Item> = team
            ...
            .map(|domain_restriction| {
                let actions = if has_admin_permissions {
                    vec![ItemAction {
                        icon: Icon::X,
                        label: crate::menu_label("settings.teams.remove_domain", "Remove domain").to_string(),
    ...
    fn render_discoverability_toggle_section(
        ...
        // toggle on the right.
        let header = self.render_subsubsection_header(crate::menu_label("settings.teams.by_discovery", "By discovery").to_owned(), appearance);

        let domain = current_user_email.split('@').nth(1).unwrap_or("");
        let team_discoverability_instructions = i18n::interpolate(
            crate::menu_label(
                "settings.teams.allow_users_with_domain",
    ...
    fn render_delete_disabled_help_text(
        ...
        if delete_disabled_reason == TeamDeleteDisabledReason::ActivePaidSubscription {
            let link = appearance
                .ui_builder()
                .link(
                    crate::menu_label("settings.teams.manage_plan", "Manage plan").into(),
                    None,
                    Some(Box::new(move |ctx| {
                ...
                match item.state {
                    ItemState::Expired => {
                        pending_and_close_row.add_child(
                            self.render_state_chip(
                                appearance,
                                crate::menu_label("settings.teams.expired", "EXPIRED").into(),
                    ...
                    ItemState::Pending => {
                        pending_and_close_row.add_child(
                            self.render_state_chip(
                                appearance,
                                crate::menu_label("settings.teams.pending", "PENDING").into(),
                    ...
                    ItemState::Owner => {
                        pending_and_close_row.add_child(
                            self.render_state_chip(
                                appearance,
                                crate::menu_label("settings.teams.owner", "OWNER").into(),
                    ...
                    ItemState::Admin => {
                        pending_and_close_row.add_child(
                            self.render_state_chip(
                                appearance,
                                crate::menu_label("settings.teams.admin", "ADMIN").into(),
                                appearance
                                    .theme()
                                    .background()
    ...
    fn render_copy_link_row(
        ...
        let (link_text, button_enabled) = match &team_metadata.invite_code {
            ...
            None => (
                crate::menu_label(
                    "settings.teams.failed_to_load_invite_link",
    ...
    fn render_create_team_page(
        ...
        page.add_child(render_sub_header(appearance, crate::menu_label("settings.teams.teams", "Teams").to_string(), None));
        page.add_child(
            self.render_sub_header_with_subtext_color(appearance, crate::menu_label("settings.teams.create_team", "Create a team").to_string()),
        );
        page.add_child(
            Container::new(
        ...
        if view.auth_state.is_on_work_domain().unwrap_or_default() {
            ...
            let checkbox_row_text = if let Some(domain) = view.auth_state.user_email_domain() {
                ...
                crate::menu_label(
                    "settings.teams.allow_users_with_same_domain",
        ...
        if !view.discoverable_teams_states.is_empty() {
            ...
            page.add_child(self.render_sub_header_with_subtext_color(
                appearance,
                crate::menu_label(
                    "settings.teams.or_join_existing_team",
    ...
    fn render_single_team_in_team_discovery(
        ...
        let teammate_string = if team_state.team.num_members == 1 {
            crate::menu_label("settings.teams.teammate_count_one", "1 teammate").to_string()
        } else {
            i18n::interpolate(
                crate::menu_label(
                    "settings.teams.teammate_count_other",
                    "{count} teammates",
                ),
    ...
    fn render_join_team_button(
        ...
        if team_state.team.team_accepting_invites {
            self.render_button(
                crate::menu_label("settings.teams.join", "Join"),
                ButtonVariant::Accent,
            ...
            appearance
                ...
                .with_centered_text_label(crate::menu_label("settings.teams.contact_admin_to_request_access", "Contact Admin to request access").to_string())
                .disabled()
                .build()
                .finish()
        }
