...
fn overage_usage_link_text() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.overage_usage_link",
        "View details on overage usage",
    )
}
fn overage_toggle_admin_header() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.overage_toggle_admin_header",
        "Enable premium model usage overages",
    )
}
fn overage_toggle_user_header_enabled() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.overage_toggle_user_header_enabled",
        "Premium model usage overages are enabled",
    )
}
fn overage_toggle_user_header_disabled() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.overage_toggle_user_header_disabled",
        "Premium model usage overages are not enabled",
    )
}
fn overage_toggle_description() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.overage_toggle_description",
...
fn overage_toggle_user_description() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.overage_toggle_user_description",
        "Ask a team admin to enable overages for more AI usage.",
    )
}

// base for PR #13374 Korean — keep fn form (do not reintroduce AUTO_RELOAD_* consts)
fn sort_menu_item_display_name_a_z_label() -> &'static str {
    crate::menu_label("settings.billing_and_usage.sort_a_to_z", "A to Z")
}
fn sort_menu_item_display_name_z_a_label() -> &'static str {
    crate::menu_label("settings.billing_and_usage.sort_z_to_a", "Z to A")
}
fn sort_menu_item_request_usage_ascending_label() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.sort_usage_ascending",
        "Usage ascending",
    )
}
fn sort_menu_item_request_usage_descending_label() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.sort_usage_descending",
        "Usage descending",
    )
}

fn auto_reload_exceed_limit_warning_string() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.auto_reload_exceed_limit",
        "Auto reload is disabled, as the next reload would exceed your monthly spend limit. Increase your limit to use auto reload.",
    )
}
fn auto_reload_delinquent_warning_string() -> &'static str {
    crate::menu_label(
...
fn restricted_billing_usage_warning_string() -> &'static str {
    crate::menu_label(
...
// base for PR #13374 Korean — keep fn form (do not reintroduce ENTERPRISE_USAGE_CALLOUT_* consts)
fn overview_tab_text() -> &'static str {
    crate::menu_label("settings.billing_and_usage.overview_tab", "Overview")
}
fn usage_history_tab_text() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.usage_history_tab",
        "Usage History",
    )
}

fn enterprise_usage_callout_header() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.enterprise_usage_callout_header",
        "Usage reporting is currently limited",
    )
}
fn enterprise_usage_callout_body_admin_prefix() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.enterprise_usage_callout_body_admin_prefix",
        "Enterprise credit usage isn't fully available in this view yet. For the most accurate spend tracking, ",
    )
}
fn enterprise_usage_callout_body_admin_link() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.enterprise_usage_callout_body_admin_link",
        "visit the admin panel",
    )
}
fn enterprise_usage_callout_body_admin_suffix() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.enterprise_usage_callout_body_admin_suffix",
        ".",
    )
}
fn enterprise_usage_callout_body_non_admin() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.enterprise_usage_callout_body_non_admin",
...
fn additional_addon_credits_description_for_team() -> &'static str {
    crate::menu_label(
        "settings.billing_and_usage.additional_addon_credits_description_for_team",
        "Purchased add-on credits are shared across your team.",
    )
}

// Cloud agent trial widget.
...
pub fn create_discount_badge(discount: u32, appearance: &Appearance) -> Box<dyn Element> {
    ...
    Container::new(
        Text::new_inline(
            crate::menu_label(
                "settings.billing_and_usage.discount_percent_off",
                "{percent}% off",
            )
            .replace("{percent}", &discount.to_string()),
...
impl BillingUsageTab {
    pub fn get_tab_from_label(label: &str) -> Self {
        match label {
            l if l == overview_tab_text() => BillingUsageTab::Overview,
            l if l == usage_history_tab_text() => BillingUsageTab::UsageHistory,
    ...
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        let overage_limit_modal_view = ctx.add_typed_action_view(|ctx| {
            Modal::new(
                Some(
                    crate::menu_label(
                        "settings.billing_and_usage.overage_spending_limit",
...
impl BillingAndUsagePageView {
    ...
    fn render_monthly_overage_spending_limit(
        ...
        let info_icon = render_info_icon(
            ...
            AdditionalInfo::<BillingAndUsagePageAction> {
                ...
                tooltip_override_text: Some(
                    crate::menu_label(
                        "settings.billing_and_usage.sets_monthly_overage_limit",
        ...
        let label = Text::new_inline(
            crate::menu_label(
                "settings.billing_and_usage.monthly_overage_spending_limit",
    ...
    fn render_addon_credits_panel(
        ...
        let header = Text::new_inline(
            crate::menu_label(
                "settings.billing_and_usage.add_on_credits",
                "Add-on credits",
            ),
            appearance.ui_font_family(),
            16.,
        ...
        let no_credits_access_explanation = match (
            ...
            (false, true, true) => {
                ...
                let (link_text, suffix) = if is_legacy_paid {
                    (
                        crate::menu_label(
                            "settings.billing_and_usage.switch_to_build",
                    ...
                    (
                        crate::menu_label(
                            "settings.billing_and_usage.upgrade_to_build",
            ...
            // Account Executive.
            (false, false, true) => {
                let paragraph_text = crate::menu_label(
            ...
            (_, _, false) => {
                let paragraph_text = crate::menu_label(
                    "settings.billing_and_usage.contact_team_admin",
        ...
        let purchased_this_month_row = if let Some(bonus_grants) = bonus_grants_purchased {
            if bonus_grants.total_credits_purchased == 0 {
                ...
                let credits_text = if credits_purchased == 1 {
                    crate::menu_label("settings.billing_and_usage.credit_singular", "1 credit")
                        .to_string()
                } else {
                    crate::menu_label(
        ...
        let auto_reload_amount = selected_option
            ...
            .unwrap_or_else(|| {
                crate::menu_label("settings.billing_and_usage.your_selected", "your selected")
                    .to_string()
            });
        ...
        let auto_reload_description = crate::menu_label(
            "settings.billing_and_usage.auto_reload_description",
            "When enabled, auto reload will automatically purchase {amount} credits when your add-on credit balance reaches 100 credits remaining.",
        )
        .replace("{amount}", &auto_reload_amount);

        let auto_reload_switch = Container::new(render_body_item::<BillingAndUsagePageAction>(
            crate::menu_label("settings.billing_and_usage.auto_reload", "Auto reload").into(),
            None,
            Default::default(),
            Default::default(),
            appearance,
        ...
        let button_text = if purchase_addon_credits_loading {
            crate::menu_label("settings.billing_and_usage.buying", "Buying…").to_string()
        } else {
            crate::menu_label("settings.billing_and_usage.buy", "Buy").to_string()
        };
                ...
                .has_failed_addon_credit_auto_reload_status()
            {
                ...
                let warning_fragments = vec![
                    FormattedTextFragment::plain_text(crate::menu_label(
                        "settings.billing_and_usage.reloading_would_exceed",
                        "Reloading would exceed your monthly limit. ",
                    )),
                    FormattedTextFragment::hyperlink_action(
                        crate::menu_label(
                            "settings.billing_and_usage.increase_your_limit",
                            "Increase your limit",
                        ),
                        BillingAndUsagePageAction::ShowAddOnCreditModal,
                    ),
                    FormattedTextFragment::plain_text(crate::menu_label(
                        "settings.billing_and_usage.to_continue",
                        " to continue.",
                    )),
                ];
    ...
    fn render_total_overages_row(
        ...
        let (request_count_label, cost_label) =
            if let (Some(count), Some(cost)) = (total_overages_count, total_overages_cost) {
                ...
                (
                    crate::menu_label("settings.billing_and_usage.zero_credits", "0 credits")
                        .to_string(),
                    crate::menu_label("settings.billing_and_usage.zero_cost", "$0.00").to_string(),
                )
            };
        ...
        let label = Text::new_inline(
            crate::menu_label(
                "settings.billing_and_usage.total_overages",
                "Total overages",
            ),
            appearance.ui_font_family(),
            12.,
        ...
        if let Some(period_end) = total_overages_period_end {
            ...
            let billing_date_text = crate::menu_label(
                "settings.billing_and_usage.usage_resets_on",
    ...
    fn render_request_usage_count(
            ...
            row.add_child(render_info_icon(
                ...
                AdditionalInfo::<BillingAndUsagePageAction> {
                    ...
                    tooltip_override_text: match info.is_current_user {
                        true => Some(crate::menu_label(
                            "settings.billing_and_usage.credit_limit_prorated_self",
                            "Your credit limit is prorated because you joined midway through the billing cycle.",
                        ).to_string()),
                        false => Some(crate::menu_label(
                            "settings.billing_and_usage.credit_limit_prorated_other",
        ...
        let request_count_label = if workspace_is_delinquent_due_to_payment_issue {
            crate::menu_label(
                "settings.billing_and_usage.restricted_due_to_billing",
                "Restricted due to billing issue",
            )
            .to_string()
        } else {
            match divisor {
                Some(Divisor::Unlimited) => crate::menu_label(
                    "settings.billing_and_usage.used_over_unlimited",
                    "{used}/Unlimited",
                )
                .replace("{used}", &used.separate_with_commas()),
                Some(Divisor::Limit(limit)) => crate::menu_label(
                    "settings.billing_and_usage.used_over_limit",
                    "{used}/{limit}",
                )
                .replace("{used}", &used.separate_with_commas())
    ...
    fn render_ai_usage_limit_row(
        ...
        let left_side = if !name.is_empty() {
            ...
            let header = crate::menu_label("settings.billing_and_usage.credits_header", "Credits");
            let description = crate::menu_label(
                "settings.billing_and_usage.credit_limit_description",
                "This is the {duration} limit of AI credits for your account.",
            )
            .replace("{duration}", &refresh_duration);
...
impl BillingAndUsagePageView {
    ...
    fn render_usage_content(
                        ...
                        Hoverable::new(self.sort_icon_mouse_state.clone(), |mouse_state| {
                            if mouse_state.is_hovered() {
                                let tooltip = appearance.ui_builder().tool_tip(
                                    crate::menu_label(
                                        "settings.billing_and_usage.sort_by",
                                        "Sort by",
                                    )
                                    .to_string(),
                                );
        ...
        if should_show_team_total {
            ...
            usage.add_child(
                self.render_ai_usage_limit_row(
                    crate::menu_label("settings.billing_and_usage.team_total", "Team total")
                        .to_string(),
                    team_total_used,
                    team_divisor,
            ...
            UserWorkspaces::as_ref(app).current_team()
        {
            if workspace_is_delinquent_due_to_payment_issue {
                if has_admin_permissions {
                    vec![
                        ...
                        FormattedTextFragment::plain_text(crate::menu_label(
                            "settings.billing_and_usage.to_regain_access_to_ai",
                            " to regain access to AI features.",
                        )),
                    ]
                } else {
                    // Non-admin team member - show message to contact admin
                    vec![FormattedTextFragment::plain_text(crate::menu_label(
                        "settings.billing_and_usage.contact_team_admin_billing",
                    ...
                    if team.billing_metadata.can_upgrade_to_build_plan() {
                        if team.billing_metadata.is_on_legacy_paid_plan() {
                            vec![
                                ...
                                FormattedTextFragment::plain_text(crate::menu_label(
                                    "settings.billing_and_usage.for_more_flexible_pricing",
                            ...
                            if team.billing_metadata.is_byo_api_key_enabled() {
                                fragments.push(FormattedTextFragment::plain_text(
                                    crate::menu_label(
                                        "settings.billing_and_usage.or_separator",
                                        " or ",
                                    ),
                                ));
                                fragments.push(FormattedTextFragment::hyperlink_action(
                                    crate::menu_label(
                                        "settings.billing_and_usage.bring_your_own_key",
                                        "bring your own key",
                                    ),
                                    BillingAndUsagePageAction::NavigateToByokSettings,
                                ));
                            }
                            fragments.push(FormattedTextFragment::plain_text(crate::menu_label(
                                "settings.billing_and_usage.for_increased_ai_access",
                        ...
                        let upgrade_text = match team.billing_metadata.customer_type {
                            CustomerType::Prosumer => crate::menu_label(
                                "settings.billing_and_usage.upgrade_to_turbo",
                                "Upgrade to Turbo plan",
                            ),
                            CustomerType::Turbo => crate::menu_label(
                                "settings.billing_and_usage.upgrade_to_lightspeed",
                                "Upgrade to Lightspeed plan",
                            ),
                            _ => crate::menu_label(
                                "settings.billing_and_usage.upgrade_plan",
                                "Upgrade",
                            ),
                        };
                        vec![
                            ...
                            FormattedTextFragment::plain_text(crate::menu_label(
                                "settings.billing_and_usage.to_get_more_ai_usage",
                ...
                vec![
                    FormattedTextFragment::hyperlink(
                        crate::menu_label(
                            "settings.billing_and_usage.upgrade_to_max",
                            "Upgrade to Max",
                        ),
                        UserWorkspaces::upgrade_link_for_team(team.uid),
                    ),
                    FormattedTextFragment::plain_text(crate::menu_label(
                        "settings.billing_and_usage.for_more_ai_credits",
                        " for more AI credits.",
                    )),
                ]
                ...
                vec![
                    FormattedTextFragment::hyperlink(
                        crate::menu_label("settings.billing_and_usage.switch_to_business", "Switch to Business"),
                        UserWorkspaces::upgrade_link_for_team(team.uid),
                    ),
                    FormattedTextFragment::plain_text(
                        crate::menu_label(
                            "settings.billing_and_usage.for_security_features",
                ...
                || team.billing_metadata.is_on_legacy_business_plan()
            {
                vec![
                    ...
                    FormattedTextFragment::plain_text(crate::menu_label(
                        "settings.billing_and_usage.for_custom_limits",
                ...
                vec![
                    FormattedTextFragment::hyperlink(
                        crate::menu_label(
                            "settings.billing_and_usage.contact_support",
                            "Contact support",
                        ),
                        "mailto:support@warp.dev",
                    ),
                    FormattedTextFragment::plain_text(crate::menu_label(
                        "settings.billing_and_usage.for_more_ai_usage",
                        " for more AI usage.",
                    )),
                ]
            } else {
            ...
            fragments.push(FormattedTextFragment::plain_text(crate::menu_label(
                "settings.billing_and_usage.for_more_credits_access",
...
impl BillingAndUsagePageView {
    fn render_anonymous_account_info(
        ...
        let user_info = appearance
            ...
            .with_text_label(
                crate::menu_label("settings.billing_and_usage.sign_up", "Sign up").to_owned(),
            )
            .build()
            .on_click(move |ctx, _, _| {
