...
impl PrivacyPageView {
    ...
    pub fn new(ctx: &mut ViewContext<PrivacyPageView>) -> Self {
        ...
        let add_regex_modal_view = ctx.add_typed_action_view(|ctx| {
            Modal::new(
                Some(i18n::t("settings.privacy.add_regex_modal.title")),
                add_regex_body,
                ctx,
            )
    ...
    fn build_page() -> PageType<Self> {
        ...
        PageType::new_uncategorized(
            widgets,
            Some(Box::leak(
                i18n::t("settings.privacy.page_title").into_boxed_str(),
            )),
        )
    }
...
impl SecretRedactionWidget {
    ...
    fn render_tab_bar(
        ...
        let personal_tab = self.render_tab(
            i18n::t("settings.privacy.tab.personal"),
            personal_count,
        ...
        let enterprise_tab = self.render_tab(
            i18n::t("settings.privacy.tab.enterprise"),
            enterprise_count,
        ...
        if is_enterprise_tab_active {
            ...
            row.add_child(self.render_info(
                i18n::t("settings.privacy.enterprise_redaction_readonly"),
                appearance,
            ));
        }
    ...
    fn render_enterprise_content(
        ...
        if enterprise_regex_list.is_empty() {
            return ui_builder
                .paragraph(i18n::t("settings.privacy.no_enterprise_regexes"))
                .with_style(UiComponentStyles {
                    font_color: Some(description_text_color),
                    ..Default::default()
                })
                ...
                Container::new(
                    Flex::row()
                        ...
                        .with_child(self.render_section_title(
                            i18n::t("settings.privacy.recommended_header"),
                            appearance,
                        ))
                        .with_child(
                            Container::new(
                                ui_builder
                                    ...
                                    .with_text_and_icon_label(Self::add_button(
                                        i18n::t("settings.privacy.add_all_button"),
                                        appearance,
                                    ))
...
impl SettingsWidget for SecretRedactionWidget {
    ...
    fn render(
            ...
            Flex::row()
                .with_child(
                    Shrinkable::new(
                        ...
                        render_sub_header(
                            appearance,
                            i18n::t("settings.privacy.safe_mode.title"),
                ...
                .with_child(
                    Container::new({
                        if is_enterprise_enabled {
                            self.render_info(
                                i18n::t("settings.privacy.enabled_by_organization"),
                                appearance,
                            )
                        } else {
                            ui_builder
        ...
        let mut column = Flex::column()
            ...
            .with_child(
                ui_builder
                    .paragraph(i18n::t("settings.privacy.safe_mode.description"))
                    .with_style(UiComponentStyles {
                        font_color: Some(description_text_color),
        ...
        if *safe_mode_settings.safe_mode_enabled {
            ...
            let label_with_icon = super::settings_page::render_dropdown_item_label(
                i18n::t("settings.privacy.secret_display_mode.label"),
                None,
            ...
            let left_content = Flex::column()
                ...
                .with_child(
                    Container::new(
                        ui_builder
                            .paragraph(i18n::t("settings.privacy.secret_display_mode.description"))
                            .with_style(UiComponentStyles {
                                font_color: Some(description_text_color),
                ...
                Flex::row()
                    ...
                    .with_child(
                        Expanded::new(
                            ...
                            Flex::column()
                                .with_child(self.render_section_title(
                                    i18n::t("settings.privacy.custom_secret_redaction.title"),
                                    appearance,
                                ))
                                .with_child(self.render_description(
                                    i18n::t("settings.privacy.custom_secret_redaction.description"),
                                    appearance,
                    ...
                    .with_child(
                        ui_builder
                            ...
                            .with_text_and_icon_label(Self::add_button(
                                i18n::t("settings.privacy.add_regex_button"),
                                appearance,
                            ))
                            .with_style(Self::add_button_style())
                            .build()
...
impl AppAnalyticsWidget {
    fn render_zero_data_retention_badge(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Hoverable::new(self.zdr_badge_mouse_state.clone(), move |mouse_state| {
            ...
            if is_hovered {
                let tooltip = ui_builder.tool_tip(i18n::t("settings.privacy.zdr.tooltip"));
...
impl SettingsWidget for AppAnalyticsWidget {
    ...
    fn render(
        ...
        let description = if is_enterprise {
            i18n::t("settings.privacy.telemetry.description_enterprise")
        } else {
        ...
        let zdr_label_component = if self.should_show_zdr_badge(app) {
            Flex::row()
                ...
                .with_child(render_body_item_label::<PrivacyPageAction>(
                    i18n::t("settings.privacy.telemetry.title"),
                    None,
                    None,
        ...
        let switch = if is_toggleable {
            ...
            switch
                .with_tooltip(TooltipConfig {
                    text: i18n::t("settings.privacy.managed_by_organization"),
        ...
        column.add_child(
            Align::new(
                ui_builder
                    .link(
                        i18n::t("settings.privacy.telemetry.read_more_link"),
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                i18n::t("settings.privacy.crash_reports.title"),
                None,
            ...
            .with_child(
                ui_builder
                    .paragraph(i18n::t("settings.privacy.crash_reports.description"))
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
                                .theme()
...
impl SettingsWidget for CloudConversationStorageWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                i18n::t("settings.privacy.cloud_conversation_storage.title"),
                None,
                LocalOnlyIconState::Hidden,
                toggle_state,
                appearance,
            ...
            .with_child(
                ui_builder
                    .paragraph(if is_checked {
                        i18n::t("settings.privacy.cloud_conversation_storage.description_enabled")
                    } else {
                        i18n::t("settings.privacy.cloud_conversation_storage.description_disabled")
                    })
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
...
impl SettingsWidget for NetworkLogWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                i18n::t("settings.privacy.network_log.title"),
                None,
            ...
            .with_child(
                ui_builder
                    .paragraph(i18n::t("settings.privacy.network_log.description"))
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
                                .theme()
            ...
            .with_child(
                Align::new(
                    ui_builder
                        .link(
                            i18n::t("settings.privacy.network_log.link"),
                            None,
                            Some(Box::new(|ctx| {
...
impl SettingsWidget for DataManagementWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                i18n::t("settings.privacy.data_management.title"),
                None,
                // Not rendering a setting, so no need to show local only icon state.
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
            ...
            .with_child(
                Align::new(
                    appearance
                        .ui_builder()
                        .link(
                            i18n::t("settings.privacy.data_management.link"),
                            None,
                            Some(Box::new(|ctx| {
                                ctx.dispatch_typed_action(
                                    PrivacyPageAction::OpenDataManagementWebpage,
...
impl SettingsWidget for PrivacyPolicyWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                i18n::t("settings.privacy.privacy_policy.title"),
                None,
                // Not rendering a setting, so no need to show local only icon state.
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
            ...
            .with_child(
                Align::new(
                    appearance
                        .ui_builder()
                        .link(
                            i18n::t("settings.privacy.privacy_policy.link"),
...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    let mut toggle_binding_pairs = vec![
        ToggleSettingActionPair::new(
            i18n::t("settings.privacy.action.app_analytics"),
        ...
        ToggleSettingActionPair::new(
            i18n::t("settings.privacy.action.crash_reporting"),
            builder(SettingsAction::PrivacyPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            i18n::t("settings.privacy.action.cloud_ai_conversation_storage"),
            builder(SettingsAction::PrivacyPageToggle(
                PrivacyPageAction::ToggleCloudConversationStorage,
            )),
            &(context.clone()
