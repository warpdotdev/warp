...
lazy_static! {
    static ref REWARDS: Vec<Reward> = vec![
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: i18n::t("settings.referrals.reward_theme"),
        },
        Reward {
            ...
            icon_width: 56.,
            icon_height: 56.,
            label: i18n::t("settings.referrals.reward_keycaps"),
        },
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: i18n::t("settings.referrals.reward_tshirt"),
        },
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: i18n::t("settings.referrals.reward_notebook"),
        },
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: i18n::t("settings.referrals.reward_cap"),
        },
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: i18n::t("settings.referrals.reward_hoodie"),
        },
        Reward {
            ...
            icon_width: 48.,
            icon_height: 48.,
            label: i18n::t("settings.referrals.reward_hydroflask"),
        },
        Reward {
            ...
            icon_width: 50.,
            icon_height: 50.,
            label: i18n::t("settings.referrals.reward_backpack"),
        },
    ];
}
...
impl ReferralsPageView {
    pub fn new(referrals_client: Arc<dyn ReferralsClient>, ctx: &mut ViewContext<Self>) -> Self {
        ...
        let header_text = i18n::t("settings.referrals.header");
        let page = PageType::new_monolith(
            ReferralsWidget::default(),
            Some(Box::leak(header_text.into_boxed_str())),
            true,
        );
        Self {
            page,
        ...
        match &self.api_state {
            ...
            ApiState::Ready { referral_info, .. } => {
                ...
                ctx.emit(ReferralsPageEvent::ShowToast {
                    message: i18n::t("settings.referrals.toast_link_copied"),
    ...
    fn handle_send_email_invite_response(
        ...
        match response {
            Ok(successful) => {
                ...
                ctx.emit(ReferralsPageEvent::ShowToast {
                    message: i18n::t("settings.referrals.toast_email_success"),
            ...
            Err(err) => {
                ...
                ctx.emit(ReferralsPageEvent::ShowToast {
                    message: i18n::t("settings.referrals.toast_email_failure"),
                    flavor: ToastFlavor::Error,
                });
            }
        }
...
impl EmailValidationError {
    ...
    fn ui_message(&self) -> String {
        match self {
            EmailValidationError::Empty => i18n::t("settings.referrals.error_empty_email"),
            EmailValidationError::Invalid(invalid_email) => {
                format!(
                    "{}{invalid_email}",
                    i18n::t("settings.referrals.error_invalid_email_prefix")
                )
            }
        }
    }
...
impl ReferralsWidget {
    ...
    fn render_link_row(
        ...
        let (link_text, button_enabled) = match &view.api_state {
            ...
            ApiState::Loading => (i18n::t("settings.referrals.loading"), false),
            ApiState::Failed => (i18n::t("settings.referrals.link_error"), false),
        };
        let theme = appearance.theme();
        let copy_link_label = i18n::t("settings.referrals.copy_link");
    ...
    fn render_email_row(
        ...
        let (button_text, button_enabled) = match &view.api_state {
            ApiState::Ready {
                email_state: SendEmailState::Idle,
                ..
            } => (i18n::t("settings.referrals.send"), true),
            ApiState::Ready {
                email_state: SendEmailState::Sending,
                ..
            } => (i18n::t("settings.referrals.sending"), false),
            _ => (i18n::t("settings.referrals.send"), false),
        };
    ...
    fn render_send_invite_section(
        ...
        Flex::column()
            .with_child(
                Container::new(
                    self.render_label(i18n::t("settings.referrals.link_label"), appearance),
                )
    ...
    fn render_signup_section(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let sign_up_button = appearance
            ...
            .with_text_label(i18n::t("settings.referrals.sign_up"))
            .build()
        ...
        Flex::column()
            .with_child(
                Container::new(
                    appearance
                        .ui_builder()
                        .span(i18n::t("settings.referrals.anonymous_header"))
                        .with_style(UiComponentStyles {
    ...
    fn render_rewards_section(
        ...
        rewards_section.add_child(
            Container::new(
                appearance
                    .ui_builder()
                    .span(i18n::t("settings.referrals.reward_intro"))
                    .with_style(UiComponentStyles {
                    ...
                    FormattedTextElement::new(
                        FormattedText::new([FormattedTextLine::Line(vec![
                            ...
                            FormattedTextFragment::hyperlink(
                                i18n::t("settings.referrals.terms_link"),
                                TERMS_URL,
                            ),
                            FormattedTextFragment::plain_text(i18n::t(
                                "settings.referrals.terms_contact",
                            )),
                        ])]),
                        12.,
    ...
    fn render_claimed_referrals_count(
        ...
        let current_referrals_label = match claimed_count {
            1 => i18n::t("settings.referrals.current_referral_singular"),
            _ => i18n::t("settings.referrals.current_referral_plural"),
        };
