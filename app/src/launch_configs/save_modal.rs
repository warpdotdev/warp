...
impl LaunchConfigSaveModal {
    ...
    fn render_save_config_button(
        ...
        self.save_modal_button(
            appearance,
            i18n::t("launch_configs.save_configuration"),
    ...
    fn render_open_file_button(&self, appearance: &Appearance) -> Box<dyn Element> {
        self.save_modal_button(
            appearance,
            i18n::t("launch_configs.open_yaml_file"),
        ...
        let header = Flex::row()
            .with_child(
                Shrinkable::new(
                    ...
                    Align::new(
                        Text::new_inline(
                            i18n::t("launch_configs.save_current_configuration"),
        ...
        let link_to_docs = Container::new(
            ConstrainedBox::new(
                appearance
                    .ui_builder()
                    .link(
                        i18n::t("launch_configs.link_to_documentation"),
                        Some(
        ...
        let info = match &self.save_state {
                    ...
                    self.render_formatted_text_line(
                        ...
                        vec![
                            FormattedTextFragment::plain_text(i18n::t(
                                "launch_configs.saved_successfully_to",
                            )),
                ...
                self.render_text_block(
                    ...
                    match failure_type {
                        FailureType::FileAlreadyExists => {
                            i18n::t("launch_configs.failed_file_already_exists")
                        }
                        FailureType::Other => i18n::t("launch_configs.failed_saving"),
                    },
                )
                .with_padding_bottom(24.)
                .finish(),
            ...
            SaveState::NotSaved => {
                let text = if self.open_modal_keybinding_str.is_empty() {
                    ...
                    i18n::t("launch_configs.description_with_shortcut")
                        .replace("{shortcut}", &self.open_modal_keybinding_str)
                };
                header
                    .with_child(
                        self.render_formatted_text_line(
...
impl View for LaunchConfigSaveModal {
    ...
    fn accessibility_contents(&self, _ctx: &AppContext) -> Option<AccessibilityContent> {
        Some(AccessibilityContent::new(
            i18n::t("launch_configs.a11y.save_config_modal"),
            i18n::t("launch_configs.a11y.save_config_modal_help"),
