...
define_settings_group!(TabSettings, settings: [
    ...
    vertical_tabs_font_size: VerticalTabsFontSize {
        type: f32,
        default: 12.0,
        supported_platforms: SupportedPlatforms::ALL,
        ...
        surface: settings::SettingSurfaces::GUI,
        private: false,
        storage_key: "VerticalTabsFontSize",
        toml_path: "appearance.vertical_tabs.font_size",
        description: "Font size (in px) used for the vertical tabs sidebar.",
    },
    vertical_tabs_font_family: VerticalTabsFontFamily {
        type: Option<String>,
        default: None,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
        surface: settings::SettingSurfaces::GUI,
        private: false,
        storage_key: "VerticalTabsFontFamily",
        toml_path: "appearance.vertical_tabs.font_family",
        description: "Optional font family used for the vertical tabs sidebar.",
    },
