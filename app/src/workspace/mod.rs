...
pub fn init(app: &mut AppContext) {
    ...
    #[cfg(feature = "dhat_heap_profiling")]
    {
        app.register_editable_bindings([EditableBinding::new(
            ...
            crate::menu_label("workspace.binding.dump_heap_profile", "Dump heap profile (can only be done once)"),
    ...
    app.register_fixed_bindings([
        ...
        FixedBinding::custom(
            ...
            crate::menu_label("workspace.binding.new_file", "New File"),
    ...
    #[cfg(target_os = "macos")]
    {
        app.register_editable_bindings([
            EditableBinding::new(
                ...
                crate::menu_label("workspace.binding.install_oz_cli", "Install Oz CLI command"),
            ...
            EditableBinding::new(
                ...
                crate::menu_label("workspace.binding.uninstall_oz_cli", "Uninstall Oz CLI command"),
