...
impl View for RewindConfirmationDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let rewind_button_label = Flex::row()
            ...
            .with_child(
                Text::new_inline(
                    i18n::t("workspace.dialog.rewind.button"),
        ...
        let cancel_button = Container::new(
            Hoverable::new(self.cancel_mouse_state.clone(), move |mouse_state| {
                ...
                Text::new_inline(
                    i18n::t("workspace.dialog.rewind.cancel"),
                    appearance.ui_font_family(),
                    14.,
                )
        ...
        let info_row = Flex::row()
            ...
            .with_child(
                Text::new_inline(
                    i18n::t("workspace.dialog.rewind.info"),
                    appearance.ui_font_family(),
                    12.,
                )
        ...
        let dialog = Container::new(
            Dialog::new(
                i18n::t("workspace.dialog.rewind.title"),
                Some(i18n::t("workspace.dialog.rewind.body")),
                UiComponentStyles {
