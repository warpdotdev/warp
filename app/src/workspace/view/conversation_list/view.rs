...
impl ConversationListView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        let query_editor = ctx.add_typed_action_view(|ctx| {
            ...
            editor.set_placeholder_text(i18n::t("workspace.conversations.search_placeholder"), ctx);
            editor
        });
        ...
        let toggle_view_all_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(i18n::t("workspace.conversations.view_all"), SecondaryTheme)
...
fn render_zero_state(
    ...
    let title_and_subtitle = Flex::column()
        ...
        .with_child(
            Text::new(
                i18n::t("workspace.conversations.empty.title"),
        ...
        .with_child(
            ConstrainedBox::new(
                FormattedTextElement::from_str(
                    i18n::t("workspace.conversations.empty.subtitle"),
                    appearance.ui_font_family(),
                    14.,
                )
    ...
    let new_conversation_button =
        Hoverable::new(zero_state_button_mouse_state, move |mouse_state| {
            let label = Text::new_inline(
                i18n::t("workspace.conversations.new_conversation"),
                appearance.ui_font_family(),
                12.,
            )
...
fn render_section_header(
    ...
    let title_text = Text::new_inline(
        match section {
            ConversationSection::Active => i18n::t("workspace.conversations.section.active"),
            ConversationSection::Past => i18n::t("workspace.conversations.section.past"),
        },
        appearance.ui_font_family(),
        11.,
    )
        ...
        match action {
            ConversationListViewAction::DeleteConversation {
                    ...
                    ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                        toast_stack.add_ephemeral_toast(
                            DismissibleToast::error(i18n::t(
                                "workspace.conversations.delete.in_progress_error",
                            )),
                            window_id,
                            ctx,
                        );
                ...
                let conversation_title = self
                    ...
                    .unwrap_or_else(|| i18n::t("workspace.conversations.fallback_title"));
            ...
            ConversationListViewAction::ToggleOverflowMenu {
                ...
                if is_open_for_same_conversation {
                    ...
                    let mut delete_item =
                        MenuItemFields::new(i18n::t("workspace.conversations.menu.delete"))
                    ...
                    if !entry.capabilities.can_delete {
                        delete_item = delete_item.with_tooltip(i18n::t(
                            "workspace.conversations.menu.delete_disabled_tooltip",
                        ));
                    }
                    ...
                    let share_item = if entry.capabilities.can_share {
                        Some(
                            MenuItemFields::new(i18n::t("workspace.conversations.menu.share"))
                                .with_on_select_action(
                    ...
                    let fork_items: Option<[MenuItem<ConversationListViewAction>; 2]> =
                        ...
                        if entry.capabilities.can_fork_locally {
                            Some([
                                MenuItemFields::new(i18n::t("workspace.conversations.menu.fork_new_pane"))
                                    .with_on_select_action(
                                    ...
                                    .into_item(),
                                MenuItemFields::new(i18n::t("workspace.conversations.menu.fork_new_tab"))
                                    .with_on_select_action(
                                        ConversationListViewAction::ForkConversation {
                                            conversation_id,
            ...
            ConversationListViewAction::ToggleViewAll => {
                ...
                let label = if self.view_all {
                    i18n::t("workspace.conversations.show_less")
                } else {
                    i18n::t("workspace.conversations.view_all")
                };
...
impl View for ConversationListView {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let content: Box<dyn Element> = if !has_conversations {
            ...
            Container::new(
                Text::new_inline(
                    i18n::t("workspace.conversations.no_matches"),
                    appearance.ui_font_family(),
