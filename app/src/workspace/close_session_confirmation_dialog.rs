...
impl View for CloseSessionConfirmationDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let dont_show_again_checkbox = appearance
            ...
            .with_label(Span::new(
                i18n::t("workspace.dialog.dont_show_again"),
                Default::default(),
            ))
        ...
        let close_session_button = appearance
            ...
            .with_centered_text_label(i18n::t("workspace.dialog.close_session_button"))
        ...
        let cancel_button = appearance
            ...
            .with_centered_text_label(i18n::t("workspace.dialog.cancel_button"))
            .with_style(button_style)
            .build()
            .with_cursor(Cursor::PointingHand)
            .on_click(move |ctx, _, _| {
        ...
        let dialog = Container::new(
            Dialog::new(
                i18n::t("workspace.dialog.close_session_title").into(),
                Some(i18n::t("workspace.dialog.close_session_shared_body").into()),
                UiComponentStyles {
                    width: Some(460.),
