...
pub struct Team {
    ...
    /// The server-owned invite-by-link URL for this team, or `None` when
    /// invite links are unavailable for this team (see `Team.inviteLink` in
    /// the GraphQL schema for the conditions).
