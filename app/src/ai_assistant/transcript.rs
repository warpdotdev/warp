...
impl Transcript {
    fn render_code_block_actions(
        ...
        buttons.add_child(appearance.ui_builder().tool_tip_on_element(
            i18n::t("ai_assistant.transcript.copy_code_tooltip"),
            ...
            || code_block_info.lang == RUNNABLE_BLOCK_MARKDOWN_LANG
        {
            ...
            buttons.add_child(
                Container::new(appearance.ui_builder().tool_tip_on_element(
                    i18n::t("ai_assistant.transcript.insert_code_tooltip"),
            ...
            buttons.add_child(
                SavePosition::new(
                    Container::new(appearance.ui_builder().tool_tip_on_element(
                        i18n::t("ai_assistant.transcript.save_as_workflow_tooltip"),
        ...
        let bottom_right_element = part.copy_all_tooltip_and_button_mouse_handles.clone().map(
            |(tooltip_handle, button_handle)| {
                ...
                appearance.ui_builder().tool_tip_on_element(
                    i18n::t("ai_assistant.transcript.copy_answer_tooltip"),
                    tooltip_handle,
                    copy_button,
                    ParentAnchor::TopRight,
                    ChildAnchor::BottomRight,
    ...
    fn render_prepared_responses(&self, appearance: &Appearance) -> Box<dyn Element> {
        Wrap::row()
            ...
            .with_child(render_prepared_response_button(
                ...
                None,
                Some(8.),
                i18n::t("ai_assistant.prompt.what_to_do_next"),
            ...
            .with_child(
                Container::new(render_prepared_response_button(
                    ...
                    None,
                    Some(8.),
                    i18n::t("ai_assistant.prompt.show_examples"),
                    "Show examples.",
                ))
                .with_margin_left(10.)
            ...
            .with_child(render_prepared_response_button(
                ...
                None,
                Some(8.),
                i18n::t("ai_assistant.prompt.how_do_i_fix_this"),
                "How do I fix this?",
            ))
            .finish()
    }
...
impl View for Transcript {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        if let RequestStatus::InFlight { request, .. } = request_status {
            ...
            let in_flight_request_text = i18n::t("ai_assistant.generating_answer");
            ...
            blocks.add_child(
                Container::new(
                    self.render_warning_message(
                        i18n::t("ai_assistant.accuracy_notice"),
                        appearance,
                    ),
                )
            ...
            if current_transcript_summarized {
                blocks.add_child(
                    Container::new(self.render_warning_message(
                        i18n::t("ai_assistant.missing_context_notice"),
                        appearance,
                    ))
