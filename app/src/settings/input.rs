...
define_settings_group!(InputSettings,
    settings: [
        show_hint_text: ShowHintText {
            ...
            description_key: "settings.schema.terminal.input.show_hint_text.description",
        },
        classic_completions_mode: ClassicCompletionsMode {
            ...
            description_key: "settings.schema.terminal.input.classic_completions_mode.description",
        },
        completions_open_while_typing: CompletionsOpenWhileTyping {
            ...
            description_key: "settings.schema.terminal.input.completions_open_while_typing.description",
        },
        error_underlining: ErrorUnderliningEnabled {
            ...
            description_key: "settings.schema.terminal.input.error_underlining_enabled.description",
        },
        syntax_highlighting: SyntaxHighlighting {
            ...
            description_key: "settings.schema.terminal.input.syntax_highlighting.description",
        },
        command_corrections: CommandCorrections {
            ...
            description_key: "settings.schema.terminal.input.command_corrections.description",
        },
        ...
        input_box_type: InputBoxTypeSetting {
            ...
            description_key: "settings.schema.terminal.input.input_box_type_setting.description",
        },
        at_context_menu_in_terminal_mode: AtContextMenuInTerminalMode {
            ...
            description_key: "settings.schema.terminal.input.at_context_menu_in_terminal_mode.description",
        },
        enable_slash_commands_in_terminal: EnableSlashCommandsInTerminal {
            ...
            description_key: "settings.schema.terminal.input.enable_slash_commands_in_terminal.description",
        },
        outline_codebase_symbols_for_at_context_menu: OutlineCodebaseSymbolsForAtContextMenu {
            ...
            description_key: "settings.schema.terminal.input.outline_codebase_symbols_for_at_context_menu.description",
        },
        ...
        show_agent_tips: ShowAgentTips {
            ...
            description_key: "settings.schema.agents.warp_agent.input.show_agent_tips.description",
        },
        ...
        show_terminal_input_message_bar: ShowTerminalInputMessageBar {
            ...
            description_key: "settings.schema.terminal.input.show_terminal_input_message_bar.description",
        },
