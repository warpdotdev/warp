...
impl WorkflowView {
                    ...
                    .for_each(|(index, argument)| {
                            ...
                            || !argument.name.eq(&self.arguments_rows[index].name)
                        {
                            let description_editor = Self::create_editor_handle(
                                ...
                                Some(ui_font_family),
                                Some(i18n::t("workflows.modal.argument_description_placeholder")),
                            ...
                            let default_value_editor = Self::create_editor_handle(
                                ...
                                Some(ui_font_family),
                                Some(i18n::t(
                                    "workflows.modal.argument_default_value_placeholder",
                                )),
                                false, /* vim_keybindings */
                                true,
                                false,
    ...
    fn render_arguments_section_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        arguments_section_row.add_child(
            Shrinkable::new(
                2.,
                self.render_section_header(i18n::t("workflows.arguments.section"), appearance),
            )
            .finish(),
        );
        ...
        if self.is_editable() {
            ...
            arguments_section_row.add_child(
                ...
                .with_tooltip(move || {
                    ui_builder
                        .tool_tip(i18n::t("workflows.argument.add_tooltip"))
                        .build()
                        .finish()
                })
                .build()
            ...
            arguments_section_row.add_child(
                Shrinkable::new(
                    ...
                    Container::new(
                        appearance
                            .ui_builder()
                            .span(i18n::t("workflows.arguments.description"))
                            .with_soft_wrap()
    ...
    fn render_alias_arguments(
        ...
        for (index, argument) in self.arguments_state.arguments.iter().enumerate() {
            ...
            if current_description.is_empty() {
                current_description
                    .push_str(&i18n::t("workflows.arguments.alias_value_placeholder"));
    ...
    fn render_env_vars_selector(
        ...
        let action_element = if self.env_vars_selector.as_ref(app).has_env_vars(app) {
            ...
            appearance
                ...
                .with_centered_text_label(i18n::t("workflows.arguments.add_environment_variables"))
                .build()
                .on_click(|ctx, _, _| {
        ...
        Flex::row()
            .with_children([
                appearance
                    .ui_builder()
                    .span(i18n::t("workflows.arguments.environment_variables"))
                    .with_style(UiComponentStyles {
                        font_size: Some(13.),
                        ..Default::default()
                    })
