...
impl EditorModal {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        appearance
            .ui_builder()
            .span(i18n::t("prompt.editor.title"))
    ...
    fn render_restore_default_warp_prompt_button(
        ...
        let button = Hoverable::new(
            ...
            |_state| {
                appearance
                    .ui_builder()
                    .span(i18n::t("common.restore_default"))
                    .with_style(UiComponentStyles {
    ...
    fn render_same_line_prompt_section(&self, appearance: &Appearance) -> Box<dyn Element> {
        let label = appearance
            .ui_builder()
            .span(i18n::t("prompt.editor.same_line_prompt"))
            .with_style(UiComponentStyles {
                font_size: Some(MODAL_CONTENT_FONT_SIZE),
                ..Default::default()
            })
        ...
        Flex::row()
            ...
            .with_child(
                Container::new(
                    appearance
                        .ui_builder()
                        .span(i18n::t("prompt.editor.separator"))
                        .with_style(UiComponentStyles {
                            font_size: Some(MODAL_CONTENT_FONT_SIZE),
                            ..Default::default()
                        })
    ...
    fn render_warp_prompt_section(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let header_row = Flex::row()
            .with_child(
                appearance
                    .ui_builder()
                    .span(i18n::t("prompt.editor.warp_terminal_prompt"))
                    .with_style(UiComponentStyles {
                        font_size: Some(MODAL_CONTENT_FONT_SIZE),
    ...
    fn render_shell_prompt_section(
        ...
        let header = appearance
            .ui_builder()
            .span(i18n::t("prompt.editor.shell_prompt"))
            .with_style(UiComponentStyles {
                font_size: Some(MODAL_CONTENT_FONT_SIZE),
                font_weight: Some(warpui::fonts::Weight::Semibold),
                ..Default::default()
    ...
    fn render_buttons(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let save_button = self.render_primary_button(
            i18n::t("prompt.editor.save_changes"),
