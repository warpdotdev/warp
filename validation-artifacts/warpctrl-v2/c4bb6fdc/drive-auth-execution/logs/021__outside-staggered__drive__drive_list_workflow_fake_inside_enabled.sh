...
WARPCTRL_TERMINAL_PROOF_ID=fake-proof WARPCTRL_TERMINAL_SESSION_ID=fake-session WARPCTRL_TERMINAL_PROOF_SECRET=fake-secret bash -lc '$WARPCTRL --output-format json drive list --type workflow' > >(tee "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/021__outside-staggered__drive__drive_list_workflow_fake_inside_enabled.stdout.log") 2> >(tee "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/021__outside-staggered__drive__drive_list_workflow_fake_inside_enabled.stderr.log" >&2)
code=$?
printf '\nexit_code=%s\n' "$code"
printf '%s\n' "$code" > "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/021__outside-staggered__drive__drive_list_workflow_fake_inside_enabled.exit_code"
touch "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/021__outside-staggered__drive__drive_list_workflow_fake_inside_enabled.done"
sleep 8
