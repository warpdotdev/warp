...
printf '$ %s\n' '$WARPCTRL --output-format json input run "printf warpctrl-validation"'
 bash -lc '$WARPCTRL --output-format json input run "printf warpctrl-validation"' > >(tee "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/006__outside-staggered__execution__input_run.stdout.log") 2> >(tee "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/006__outside-staggered__execution__input_run.stderr.log" >&2)
code=$?
printf '\nexit_code=%s\n' "$code"
printf '%s\n' "$code" > "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/006__outside-staggered__execution__input_run.exit_code"
touch "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/006__outside-staggered__execution__input_run.done"
sleep 8
