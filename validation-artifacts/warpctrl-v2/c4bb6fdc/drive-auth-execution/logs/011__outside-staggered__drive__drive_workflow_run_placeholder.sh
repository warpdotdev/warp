...
printf '$ %s\n' '$WARPCTRL --output-format json drive workflow run placeholder-workflow-id --arg validation=warpctrl'
 bash -lc '$WARPCTRL --output-format json drive workflow run placeholder-workflow-id --arg validation=warpctrl' > >(tee "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/011__outside-staggered__drive__drive_workflow_run_placeholder.stdout.log") 2> >(tee "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/011__outside-staggered__drive__drive_workflow_run_placeholder.stderr.log" >&2)
code=$?
printf '\nexit_code=%s\n' "$code"
printf '%s\n' "$code" > "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/011__outside-staggered__drive__drive_workflow_run_placeholder.exit_code"
touch "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/011__outside-staggered__drive__drive_workflow_run_placeholder.done"
sleep 8
