...
printf '$ %s\n' '$WARPCTRL --output-format json drive list --type workflow'
 bash -lc '$WARPCTRL --output-format json drive list --type workflow' > >(tee "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/007__outside-staggered__drive__drive_list_workflow.stdout.log") 2> >(tee "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/007__outside-staggered__drive__drive_list_workflow.stderr.log" >&2)
code=$?
printf '\nexit_code=%s\n' "$code"
printf '%s\n' "$code" > "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/007__outside-staggered__drive__drive_list_workflow.exit_code"
touch "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/007__outside-staggered__drive__drive_list_workflow.done"
sleep 8
