...
WARPCTRL_TERMINAL_PROOF_ID=fake-proof WARPCTRL_TERMINAL_SESSION_ID=fake-session WARPCTRL_TERMINAL_PROOF_SECRET=fake-secret bash -lc '$WARPCTRL --output-format json input run "printf warpctrl-validation"' > >(tee "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/014__outside-staggered__execution__input_run_fake_inside.stdout.log") 2> >(tee "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/014__outside-staggered__execution__input_run_fake_inside.stderr.log" >&2)
code=$?
printf '\nexit_code=%s\n' "$code"
printf '%s\n' "$code" > "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/014__outside-staggered__execution__input_run_fake_inside.exit_code"
touch "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/014__outside-staggered__execution__input_run_fake_inside.done"
sleep 8
