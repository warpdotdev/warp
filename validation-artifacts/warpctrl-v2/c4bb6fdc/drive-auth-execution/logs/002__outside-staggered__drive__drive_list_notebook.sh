...
printf '$ %s\n' '$WARPCTRL --output-format json drive list --type notebook'
 bash -lc '$WARPCTRL --output-format json drive list --type notebook' > >(tee "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/002__outside-staggered__drive__drive_list_notebook.stdout.log") 2> >(tee "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/002__outside-staggered__drive__drive_list_notebook.stderr.log" >&2)
code=$?
printf '\nexit_code=%s\n' "$code"
printf '%s\n' "$code" > "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/002__outside-staggered__drive__drive_list_notebook.exit_code"
touch "/workspace/warpctrl-validation/drive-auth-execution/validation-artifacts/warpctrl-v2/c4bb6fdc/drive-auth-execution/logs/002__outside-staggered__drive__drive_list_notebook.done"
sleep 8
